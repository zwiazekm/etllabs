CREATE PROCEDURE [stat].dgp_import_intr_doszacowanie_generacja_ver_2
  @p_data_od datetime,
  @p_data_do datetime
as
  declare @v_komunikat varchar(1024)
  --
  set @v_komunikat = 'start: dgp_import_intr_doszacowanie_generacja_ver_2 od ' + convert(varchar(12), @p_data_od) + ' do '+ convert(varchar(12), @p_data_do)
  --
  ...
  --
  exec stat.DziennikWpisInfo 'stop: dgp_import_intr_doszacowanie_generacja_ver_2'
  --