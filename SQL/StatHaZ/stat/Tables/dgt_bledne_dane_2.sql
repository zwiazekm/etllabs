CREATE TABLE [stat].[dgt_bledne_dane_2] (
    [bd_RokMc]          INT           NULL,
    ...
    CONSTRAINT [CK_dgt_bledne_dane_2] CHECK (NOT [bd_nowa_wartosc] like '% %' AND NOT [bd_nowa_wartosc] like '%,%' AND NOT [bd_nowa_wartosc] like '%.%')
);
