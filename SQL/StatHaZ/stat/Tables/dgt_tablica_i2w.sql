CREATE TABLE [stat].[dgt_tablica_i2w] (
...
CREATE STATISTICS [ti_mb_wartosc]
    ON [stat].[dgt_tablica_i2w]([ti_mb_wartosc]);


GO
CREATE STATISTICS [ti_mb_wartosc100]
    ON [stat].[dgt_tablica_i2w]([ti_mb_wartosc100]);


GO
CREATE STATISTICS [ti_mp_wartosc100]
    ON [stat].[dgt_tablica_i2w]([ti_mp_wartosc100]);


GO
CREATE STATISTICS [ti_on_wartosc]
    ON [stat].[dgt_tablica_i2w]([ti_on_wartosc]);


GO
CREATE STATISTICS [ti_on_wartosc100]
    ON [stat].[dgt_tablica_i2w]([ti_on_wartosc100]);


GO
CREATE STATISTICS [ti_pcn]
    ON [stat].[dgt_tablica_i2w]([ti_pcn]);
