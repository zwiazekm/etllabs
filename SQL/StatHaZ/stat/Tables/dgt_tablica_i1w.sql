CREATE TABLE [stat].[dgt_tablica_i1w] (
...
CREATE STATISTICS [ti_mb_masa]
    ON [stat].[dgt_tablica_i1w]([ti_mb_masa]);


GO
CREATE STATISTICS [ti_mb_srednia_cena]
    ON [stat].[dgt_tablica_i1w]([ti_mb_srednia_cena]);


GO
CREATE STATISTICS [ti_mb_wartosc]
    ON [stat].[dgt_tablica_i1w]([ti_mb_wartosc]);


GO
CREATE STATISTICS [ti_on_masa]
    ON [stat].[dgt_tablica_i1w]([ti_on_masa]);


GO
CREATE STATISTICS [ti_on_srednia_cena]
    ON [stat].[dgt_tablica_i1w]([ti_on_srednia_cena]);


GO
CREATE STATISTICS [ti_on_wartosc]
    ON [stat].[dgt_tablica_i1w]([ti_on_wartosc]);


GO
CREATE STATISTICS [ti_op_masa]
    ON [stat].[dgt_tablica_i1w]([ti_op_masa]);


GO
CREATE STATISTICS [ti_op_srednia_cena]
    ON [stat].[dgt_tablica_i1w]([ti_op_srednia_cena]);


GO
CREATE STATISTICS [ti_op_wartosc]
    ON [stat].[dgt_tablica_i1w]([ti_op_wartosc]);
