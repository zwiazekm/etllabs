CREATE TABLE [stat].[dgt_tablica_s2p] (
...
CREATE STATISTICS [ts_mb_wartosc]
    ON [stat].[dgt_tablica_s2p]([ts_mb_wartosc]);


GO
CREATE STATISTICS [ts_mb_wartosc100]
    ON [stat].[dgt_tablica_s2p]([ts_mb_wartosc100]);


GO
CREATE STATISTICS [ts_mp_wartosc100]
    ON [stat].[dgt_tablica_s2p]([ts_mp_wartosc100]);


GO
CREATE STATISTICS [ts_on_wartosc]
    ON [stat].[dgt_tablica_s2p]([ts_on_wartosc]);


GO
CREATE STATISTICS [ts_on_wartosc100]
    ON [stat].[dgt_tablica_s2p]([ts_on_wartosc100]);


GO
CREATE STATISTICS [ts_pcn]
    ON [stat].[dgt_tablica_s2p]([ts_pcn]);
