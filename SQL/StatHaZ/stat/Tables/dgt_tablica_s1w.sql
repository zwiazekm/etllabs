CREATE TABLE [stat].[dgt_tablica_s1w] (
...
CREATE STATISTICS [ts_mb_masa]
    ON [stat].[dgt_tablica_s1w]([ts_mb_masa]);


GO
CREATE STATISTICS [ts_mb_srednia_cena]
    ON [stat].[dgt_tablica_s1w]([ts_mb_srednia_cena]);


GO
CREATE STATISTICS [ts_mb_wartosc]
    ON [stat].[dgt_tablica_s1w]([ts_mb_wartosc]);


GO
CREATE STATISTICS [ts_on_masa]
    ON [stat].[dgt_tablica_s1w]([ts_on_masa]);


GO
CREATE STATISTICS [ts_on_srednia_cena]
    ON [stat].[dgt_tablica_s1w]([ts_on_srednia_cena]);


GO
CREATE STATISTICS [ts_on_wartosc]
    ON [stat].[dgt_tablica_s1w]([ts_on_wartosc]);


GO
CREATE STATISTICS [ts_op_masa]
    ON [stat].[dgt_tablica_s1w]([ts_op_masa]);


GO
CREATE STATISTICS [ts_op_srednia_cena]
    ON [stat].[dgt_tablica_s1w]([ts_op_srednia_cena]);


GO
CREATE STATISTICS [ts_op_wartosc]
    ON [stat].[dgt_tablica_s1w]([ts_op_wartosc]);
