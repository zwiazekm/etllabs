CREATE TABLE [stat].[import_sad_sads_agr_F16] (
    ...
    [im_kraj_zakupu]                 VARCHAR (255) NULL,
    [im_odbiorca]                    VARCHAR (255) NULL,
    [im_miesiac_rok]                 VARCHAR (255) NULL,
    [im_rodzaj_transakcji]           VARCHAR (255) NULL,
    [im_kod_transportu_g]            VARCHAR (255) NULL,
    [im_kod_transportu_w]            VARCHAR (255) NULL,
    [im_kod_warunkow_dostawy]        VARCHAR (255) NULL,
    [im_kod_izby_celnej]             VARCHAR (255) NULL,
    [im_kod_procedury_celnej]        VARCHAR (255) NULL,
    [im_kod_waluty]                  VARCHAR (255) NULL,
    [im_kod_kraju_srodka_transportu] VARCHAR (255) NULL,
    [im_kontener]                    VARCHAR (255) NULL,
    [im_kod_preferencji]             VARCHAR (255) NULL,
    [im_masa_netto]                  VARCHAR (255) NULL,
    [im_masa_brutto]                 VARCHAR (255) NULL,
    ...
    [im_wartosc_pozycji]             VARCHAR (255) NULL
);
