...
CREATE procedure [wald].p_widelki_wartosc_na_kg 	
@zakres decimal(2,2)
...
select 	@posredniaSe =avg((cast((cast(EKS.ek_wartosc_stat_zl as decimal(20,2)))/(cast(EKS.ek_masa_netto as decimal(20,2)))as decimal(20,2)))),
	@podchylenieSe =stdevp((cast((cast(EKS.ek_wartosc_stat_zl as decimal(20,2)))/(cast(EKS.ek_masa_netto as decimal(20,2)))as decimal(20,2)))) 
from	[wald].widelki_zbior_roczny_eksport EKS
where	(EKS.ek_pcn = @kod_cn) and
	(cast(EKS.ek_masa_netto as int) <> 0) and
	(cast(EKS.ek_wartosc_stat_zl as int) <> 0)and
	(EKS.ek_odbiorca <> '22222222222222')and
	(EKS.ek_znacznik_kategorii_progowej = '0')

select	@posredniaSi =avg((cast((cast(IMP.im_wartosc_stat_zl as decimal(20,2)))/(cast(IMP.im_masa_netto as decimal(20,2)))as decimal(20,2)))),
	@podchylenieSi =stdevp((cast((cast(IMP.im_wartosc_stat_zl as decimal(20,2)))/(cast(IMP.im_masa_netto as decimal(20,2)))as decimal(20,2))))
from	[wald].widelki_zbior_roczny_import IMP
where	(IMP.im_pcn = @kod_cn)and
	(cast(IMP.im_masa_netto as int) <> 0) and
...
select 	@posredniaIe =avg((cast((cast(EKS.ek_wartosc_stat_zl as decimal(20,2)))/(cast(EKS.ek_masa_netto as decimal(20,2)))as decimal(20,2)))),
	@podchylenieIe =stdevp((cast((cast(EKS.ek_wartosc_stat_zl as decimal(20,2)))/(cast(EKS.ek_masa_netto as decimal(20,2)))as decimal(20,2))))
from	[wald].widelki_zbior_roczny_eksport EKS
where	(EKS.ek_pcn = @kod_cn) and
	(cast(EKS.ek_wartosc_stat_zl as int) <> 0)and
	(cast(EKS.ek_masa_netto as int)) <> 0 and
...
select	@posredniaIi =avg((cast((cast(IMP.im_wartosc_stat_zl as decimal(20,2)))/(cast(IMP.im_masa_netto as decimal(20,2)))as decimal(20,2)))),
	@podchylenieIi =stdevp((cast((cast(IMP.im_wartosc_stat_zl as decimal(20,2)))/(cast(IMP.im_masa_netto as decimal(20,2)))as decimal(20,2))))
from	[wald].widelki_zbior_roczny_import IMP
where	(IMP.im_pcn = @kod_cn)and
	(cast(IMP.im_masa_netto as int)) <> 0 and
	(cast(IMP.im_wartosc_stat_zl as int) <> 0)and
...
insert into [wald].widelki_wartosc_na_kg
select 	@kod_cn,
...
print 'ZASILONO TABELĘ WIDELKI_WARTOSC_NA_KG; POLA "NULL" OZNACZAJĄ BRAK DANYCH HISTORYCZNYCH'