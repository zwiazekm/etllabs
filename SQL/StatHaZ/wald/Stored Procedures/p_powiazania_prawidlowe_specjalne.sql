...
CREATE procedure [wald].p_powiazania_prawidlowe_specjalne
as
-----------------------------------------
...
insert into wald.tbl_sprawdzenie_powiazan_specjalne
	select distinct
	POZ.kod_towarowy,
	...
	wald.tbl_powiazan_prawidlowych_specjalne POW
