CREATE TABLE [wald].[wal_dgt_kopia_ecs_exp_goods_item] (
    ...
    CONSTRAINT [PK_wal_dgt_kopia_ecs_exp_goods_item] PRIMARY KEY CLUSTERED ([id] ASC, [declcoexport_decl_id] ASC) ON [WaldDane]
);
