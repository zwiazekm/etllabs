CREATE TABLE [wald].[wal_dgt_kopia_ecs_exp_goods_item_WART_STAT_ECS] (
...
CREATE TRIGGER [wald].[uname_wart_stat_ecs] ON [wald].[wal_dgt_kopia_ecs_exp_goods_item_WART_STAT_ECS] 
FOR UPDATE
AS
update  [wald].[wal_dgt_kopia_ecs_exp_goods_item_WART_STAT_ECS] 
