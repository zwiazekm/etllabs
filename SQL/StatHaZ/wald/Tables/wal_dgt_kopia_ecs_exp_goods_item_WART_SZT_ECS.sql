CREATE TABLE [wald].[wal_dgt_kopia_ecs_exp_goods_item_WART_SZT_ECS] (
...
CREATE TRIGGER [wald].[uname_wart_szt_ecs] ON [wald].[wal_dgt_kopia_ecs_exp_goods_item_WART_SZT_ECS] 
FOR UPDATE
AS
update [wald].[wal_dgt_kopia_ecs_exp_goods_item_WART_SZT_ECS] 
