CREATE TABLE [wald].[agregaty_eksport_przeslane_z_GUS_wyliczenia] (
    ...
    [GUS_zglosil]     DATETIME        NOT NULL,
    [uwagi_CAAC]      VARCHAR (255)   NULL,
    [prop_rodz_bledu] VARCHAR (50)    NULL,
    [wart_jm]         NUMERIC (18, 2) NULL,
    [wart_kg]         NUMERIC (18, 2) NULL
) ON [WaldDane];
