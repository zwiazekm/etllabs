CREATE TABLE [wald].[wal_dgt_kopia_v2_sad_dpdz_tow_WARTOSC_SAD] (
    [stat]                 CHAR (1)        NULL,
    ...
    CONSTRAINT [PK_wal_dgt_kopia_v2_sad_dpdz_tow_WARTOSC_SAD] PRIMARY KEY CLUSTERED ([idDokNr] ASC, [PozId] ASC) ON [WaldDane]
);


GO

CREATE TRIGGER [wald].[uname_wart_sad] ON wald.wal_dgt_kopia_v2_sad_dpdz_tow_WARTOSC_SAD 
FOR UPDATE
AS
update [wald].[wal_dgt_kopia_v2_sad_dpdz_tow_WARTOSC_SAD] 
