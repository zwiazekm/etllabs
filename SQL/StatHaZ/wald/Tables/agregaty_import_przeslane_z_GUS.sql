CREATE TABLE [wald].[agregaty_import_przeslane_z_GUS] (
    ...
    [GUS_zglosil] DATETIME      CONSTRAINT [DF_agregaty_import_przeslane_z_GUS_GUS_zglosil] DEFAULT (getdate()) NOT NULL,
