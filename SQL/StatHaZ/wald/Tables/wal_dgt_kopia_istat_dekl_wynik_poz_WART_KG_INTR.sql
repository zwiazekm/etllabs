CREATE TABLE [wald].[wal_dgt_kopia_istat_dekl_wynik_poz_WART_KG_INTR] (
...
CREATE TRIGGER [wald].[uname_wart_kg_intr] ON [wald].[wal_dgt_kopia_istat_dekl_wynik_poz_WART_KG_INTR] 
FOR UPDATE
AS
update [wald].[wal_dgt_kopia_istat_dekl_wynik_poz_WART_KG_INTR] 
