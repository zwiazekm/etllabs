CREATE TABLE [wald].[wal_dgt_kopia_ecs_exp_goods_item_WART_KG_ECS] (
...
CREATE TRIGGER [wald].[uname_wart_kg_ecs] ON [wald].[wal_dgt_kopia_ecs_exp_goods_item_WART_KG_ECS] 
FOR UPDATE
AS
update wald.wal_dgt_kopia_ecs_exp_goods_item_WART_KG_ECS
