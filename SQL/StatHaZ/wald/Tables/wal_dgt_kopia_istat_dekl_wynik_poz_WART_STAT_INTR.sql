CREATE TABLE [wald].[wal_dgt_kopia_istat_dekl_wynik_poz_WART_STAT_INTR] (
    ...
    CONSTRAINT [PK_wal_dgt_kopia_istat_dekl_wynik_poz_WART_STAT_INTR] PRIMARY KEY CLUSTERED ([id_dok] ASC, [pozid] ASC) ON [WaldDane]
);


GO

CREATE TRIGGER [wald].[uname_wart_stat_intr] ON [wald].[wal_dgt_kopia_istat_dekl_wynik_poz_WART_STAT_INTR] 
FOR UPDATE
AS
update [wald].[wal_dgt_kopia_istat_dekl_wynik_poz_WART_STAT_INTR] 
