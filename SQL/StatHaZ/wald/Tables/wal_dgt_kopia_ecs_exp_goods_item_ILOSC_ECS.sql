CREATE TABLE [wald].[wal_dgt_kopia_ecs_exp_goods_item_ILOSC_ECS] (
...
CREATE TRIGGER [wald].[uname_ilosc_ecs] ON [wald].[wal_dgt_kopia_ecs_exp_goods_item_ILOSC_ECS] 
FOR UPDATE
AS
update [wald].[wal_dgt_kopia_ecs_exp_goods_item_ILOSC_ECS]
