CREATE PROCEDURE [gust].sp_ExecPackage_eksport_do_statystyki
AS

Declare @execution_id bigint
EXEC [SSISDB].[catalog].[create_execution] @package_name=N'04_Eksport_do_Statystyki.dtsx', @execution_id=@execution_id OUTPUT, @folder_name=N'Ariadna2', @project_name=N'StatHaZ_SSIS', @use32bitruntime=False, @reference_id=Null
Select @execution_id
