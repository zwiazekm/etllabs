CREATE TABLE [pdr].[c084] (
    ...
    [valid_to]             DATE           NULL,
    [version_]             BIGINT         CONSTRAINT [DF__c084__version___5B4E756C] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK__c084__E38030561492CCE7] PRIMARY KEY CLUSTERED ([c084_id] ASC) ON [FG_PDR]
);
