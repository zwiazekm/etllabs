CREATE TABLE [pdr].[c4000_daneadresowe] (
    ...
    PRIMARY KEY CLUSTERED ([c4000_daneadresowe_id] ASC) ON [FG_PDR],
    CONSTRAINT [c4000_daneadresowe_c4000_id_fkey] FOREIGN KEY ([c4000_id]) REFERENCES [pdr].[c4000] ([c4000_id])
);
