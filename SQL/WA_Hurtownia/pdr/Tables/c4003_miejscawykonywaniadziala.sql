CREATE TABLE [pdr].[c4003_miejscawykonywaniadziala] (
    ...
    PRIMARY KEY CLUSTERED ([c4003_miejscawykonywaniadziala_id] ASC) ON [FG_PDR],
    CONSTRAINT [c4003_miejscawykonywaniadzial_c4003_szczegolydzialalnosci__fkey] FOREIGN KEY ([c4003_szczegolydzialalnosci_id]) REFERENCES [pdr].[c4003_szczegolydzialalnosci] ([c4003_szczegolydzialalnosci_id])
);
