CREATE TABLE [zef2DP].[AKC4_ZalacznikD_InfKwotWplatDzien] (
    ...
    CONSTRAINT [AKC4_ZalacznikD_InfKwotWplatDzien_PK] PRIMARY KEY CLUSTERED ([IdentyfikatorWpisu] ASC) ON [FG_ZEF2DP]
);
