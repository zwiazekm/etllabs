CREATE TABLE [zef2DP].[AKC4_ZalacznikA_InfKwotWplatDzien] (
    ...
    CONSTRAINT [AKC4_ZalacznikA_InfKwotWplatDzien_PK] PRIMARY KEY CLUSTERED ([IdentyfikatorWpisu] ASC) ON [FG_ZEF2DP]
);
