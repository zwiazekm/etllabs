CREATE TABLE [zef2DP].[AKC4_ZalacznikC_InfKwotWplatDzien] (
    ...
    CONSTRAINT [AKC4_ZalacznikC_InfKwotWplatDzien_PK] PRIMARY KEY CLUSTERED ([IdentyfikatorWpisu] ASC) ON [FG_ZEF2DP]
);
