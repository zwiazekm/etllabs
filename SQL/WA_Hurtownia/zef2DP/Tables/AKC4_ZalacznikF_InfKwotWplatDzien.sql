CREATE TABLE [zef2DP].[AKC4_ZalacznikF_InfKwotWplatDzien] (
    ...
    CONSTRAINT [AKC4_ZalacznikF_InfKwotWplatDzien_PK] PRIMARY KEY CLUSTERED ([IdentyfikatorWpisu] ASC) ON [FG_ZEF2DP]
);
