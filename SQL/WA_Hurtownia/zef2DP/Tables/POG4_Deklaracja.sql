CREATE TABLE [zef2DP].[POG4_Deklaracja] (
    ...
    [LiczbaZlozonychZalacznikowPOG4A]       INT             NULL,
    [LiczbaZlozonychZalacznikowPOG4R]       INT             NULL,
    [KwotaPodatkuPOG4A]                     DECIMAL (19, 2) NULL,
    [KwotaPodatkuPOG4R]                     DECIMAL (19, 2) NULL,
    [RazemKwotaPodatkuAkc]                  DECIMAL (19, 2) NULL,
    ...
    CONSTRAINT [POG4_Deklaracja_PK] PRIMARY KEY CLUSTERED ([IdentyfikatorDokumentu] ASC) ON [FG_ZEF2DP]
);


GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20160803-121637]
    ON [zef2DP].[POG4_Deklaracja]([NumerDokumentu] ASC)
    ON [FG_ZEF2DP];


GO
CREATE TRIGGER [zef2DP].[POG4_DeklaracjaTrigger]
   ON  zef2DP.POG4_Deklaracja
   AFTER INSERT,UPDATE
AS 
BEGIN
...
BEGIN
 ...
 UPDATE [zef2DP].[POG4_Deklaracja] SET CzyOstatniaWersjaDeklaracji = 'false' WHERE NumerDokumentu = @current_template_id;
...
UPDATE[zef2DP].[POG4_Deklaracja]
SET CzyOstatniaWersjaDeklaracji = 'true' 
WHERE NumerDokumentu = 
 (SELECT MAX(NumerDokumentu) AS NumerDokumentu FROM [zef2DP].[POG4_Deklaracja]
