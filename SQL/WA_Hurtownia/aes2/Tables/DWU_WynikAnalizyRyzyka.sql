CREATE TABLE [aes2].[DWU_WynikAnalizyRyzyka] (
    ...
    CONSTRAINT [DWU_WynikAnalizyRyzyka$PK_DWU_WynikAnalizyRyzyka] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_AES2],
    CONSTRAINT [FK__DWU_WynikAnalizyRyzyka_IdDokDWU__DWU_Dokument_id] FOREIGN KEY ([IdDokDWU]) REFERENCES [aes2].[DWU_Dokument] ([Id])
);
