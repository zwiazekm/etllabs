CREATE TABLE [aes2].[ZUZ_DokumentWymagany] (
    ...
    CONSTRAINT [ZUZ_DokumentWymagany$PK_ZUZ_DokumentWymagany] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZUZ_DokumentWymagany_IdTowarZUZ__ZUZ_Dokument_id] FOREIGN KEY ([IdTowarZUZ]) REFERENCES [aes2].[ZUZ_Towar] ([Id])
);
