CREATE TABLE [aes2].[QUERY_TowarPodmiot] (
    ...
    CONSTRAINT [QUERY_TowarPodmiot$PK_QUERY_TowarPodmiot] PRIMARY KEY CLUSTERED ([Id] ASC, [RodzPodmiotu] ASC) ON [FG_AES2],
    CONSTRAINT [FK__QUERY_TowarPodmiot_IdTowarQUERY__QUERY_Towar_id] FOREIGN KEY ([IdTowarQUERY]) REFERENCES [aes2].[QUERY_Towar] ([Id])
);
