CREATE TABLE [aes2].[ZUZ_TowarPodmiot] (
    ...
    CONSTRAINT [ZUZ_TowarPodmiot$PK_ZUZ_TowarPodmiot] PRIMARY KEY CLUSTERED ([Id] ASC, [RodzPodmiotu] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZUZ_TowarPodmiot_IdTowarZUZ__ZUZ_Dokument_id] FOREIGN KEY ([IdTowarZUZ]) REFERENCES [aes2].[ZUZ_Towar] ([Id])
);
