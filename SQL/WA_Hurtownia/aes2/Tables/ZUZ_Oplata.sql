CREATE TABLE [aes2].[ZUZ_Oplata] (
    ...
    CONSTRAINT [ZUZ_Oplata$PK_ZUZ_Oplata] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZUZ_Oplata_IdTowarZUZ__ZUZ_Dokument_id] FOREIGN KEY ([IdTowarZUZ]) REFERENCES [aes2].[ZUZ_Towar] ([Id])
);
