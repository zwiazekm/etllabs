CREATE TABLE [aes2].[ZUZ_Opakowanie] (
    ...
    CONSTRAINT [ZUZ_Opakowanie$PK_ZUZ_Opakowanie] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZUZ_Opakowanie_IdTowarZUZ__ZUZ_Dokument_id] FOREIGN KEY ([IdTowarZUZ]) REFERENCES [aes2].[ZUZ_Towar] ([Id])
);
