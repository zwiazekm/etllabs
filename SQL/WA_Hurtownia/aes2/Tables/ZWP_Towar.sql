CREATE TABLE [aes2].[ZWP_Towar] (
    ...
    CONSTRAINT [ZWP_Towar$PK_ZWP_Towar] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZWP_Towar_IdDokZWP__ZWP_Dokument_id] FOREIGN KEY ([IdDokZWP]) REFERENCES [aes2].[ZWP_Dokument] ([Id])
);
