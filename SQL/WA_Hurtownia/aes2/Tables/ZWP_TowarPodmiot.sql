CREATE TABLE [aes2].[ZWP_TowarPodmiot] (
    ...
    CONSTRAINT [ZWP_TowarPodmiot$PK_ZWP_TowarPodmiot] PRIMARY KEY CLUSTERED ([Id] ASC, [RodzPodmiotu] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZWP_TowarPodmiot_IdTowarZWP__ZWP_Towar_id] FOREIGN KEY ([IdTowarZWP]) REFERENCES [aes2].[ZWP_Towar] ([id])
);
