CREATE TABLE [aes2].[ZUZ_Zglaszajacy] (
    ...
    CONSTRAINT [ZUZ_Zglaszajacy$PK_ZUZ_Zglaszajacy] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZUZ_Zglaszajacy_IdDokZUZ__ZUZ_Dokument_id] FOREIGN KEY ([IdDokZUZ]) REFERENCES [aes2].[ZUZ_Dokument] ([Id])
);
