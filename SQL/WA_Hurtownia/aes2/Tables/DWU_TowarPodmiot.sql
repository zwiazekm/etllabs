CREATE TABLE [aes2].[DWU_TowarPodmiot] (
    ...
    CONSTRAINT [DWU_TowarPodmiot$PK_DWU_TowarPodmiot] PRIMARY KEY CLUSTERED ([Id] ASC, [RodzPodmiotu] ASC) ON [FG_AES2],
    CONSTRAINT [FK__DWU_TowarPodmiot_IdTowarDWU__DWU_Towar_id] FOREIGN KEY ([IdTowarDWU]) REFERENCES [aes2].[DWU_Towar] ([Id])
);
