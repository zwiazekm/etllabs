CREATE TABLE [aes2].[ZUZ_Podmiot] (
    ...
    CONSTRAINT [ZUZ_Podmiot$PK_ZUZ_Podmiot] PRIMARY KEY CLUSTERED ([Id] ASC, [RodzPodmiotu] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZUZ_Podmiot_IdDokZUZ__ZUZ_Dokument_id] FOREIGN KEY ([IdDokZUZ]) REFERENCES [aes2].[ZUZ_Dokument] ([Id])
);
