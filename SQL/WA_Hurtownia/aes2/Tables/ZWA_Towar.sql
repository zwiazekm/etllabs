CREATE TABLE [aes2].[ZWA_Towar] (
    ...
    CONSTRAINT [ZWA_Towar$PK_ZWA_Towar] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZWA_Towar_IdDokZWA__ZWA_Dokument_id] FOREIGN KEY ([IdDokZWA]) REFERENCES [aes2].[ZWA_Dokument] ([Id])
);
