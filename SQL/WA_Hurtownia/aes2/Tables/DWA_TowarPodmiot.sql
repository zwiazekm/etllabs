CREATE TABLE [aes2].[DWA_TowarPodmiot] (
    ...
    CONSTRAINT [DWA_TowarPodmiot$PK_DWA_TowarPodmiot] PRIMARY KEY CLUSTERED ([Id] ASC, [RodzPodmiotu] ASC) ON [FG_AES2],
    CONSTRAINT [FK__DWA_TowarPodmiot_IdTowarDWA__DWA_Towar_id] FOREIGN KEY ([IdTowarDWA]) REFERENCES [aes2].[DWA_Towar] ([Id])
);
