CREATE TABLE [aes2].[ZWA_Podmiot] (
    ...
    CONSTRAINT [ZWA_Podmiot$PK_ZWA_Podmiot] PRIMARY KEY CLUSTERED ([Id] ASC, [RodzPodmiotu] ASC) ON [FG_AES2],
    CONSTRAINT [FK__ZWA_Podmiot_IdDokZWA__ZWA_Dokument_id] FOREIGN KEY ([IdDokZWA]) REFERENCES [aes2].[ZWA_Dokument] ([Id])
);
