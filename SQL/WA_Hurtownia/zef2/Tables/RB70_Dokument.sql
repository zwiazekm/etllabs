CREATE TABLE [zef2].[RB70_Dokument] (
    ...
    CONSTRAINT [RB70_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB70_Doku__Ident__782AAB3C] CHECK ([IdentyfikatorRekordu]<>(0))
