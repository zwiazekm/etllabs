CREATE TABLE [zef2].[Bilans_Pozycje] (
    ...
    [StanNaKoniecRokuPoprzedniego]      NUMERIC (32, 16) NOT NULL,
    [StanNaKoniecRokuBiezacego]         NUMERIC (32, 16) NOT NULL,
    ...
    CONSTRAINT [Bilans_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC) ON [FG_ZEF2],
