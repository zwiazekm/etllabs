CREATE TABLE [zef2].[RBBZ1_Pozycje] (
    ...
    [KwotaPlanuWgUstawyBudzetowej]      NUMERIC (32, 16) NOT NULL,
    [PlanPoZmianach]                    NUMERIC (32, 16) NOT NULL,
    [Wykonanie]                         NUMERIC (32, 16) NOT NULL,
    [Zobowiazania]                      NUMERIC (32, 16) NOT NULL,
    ...
    CONSTRAINT [RBBZ1_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC) ON [FG_ZEF2]
);
