CREATE TABLE [zef2].[RB28Programy_Dokument] (
    ...
    CONSTRAINT [RB28Programy_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB28Progr__Ident__70898974] CHECK ([IdentyfikatorRekordu]<>(0))
