CREATE TABLE [zef2].[RB27_Dokument] (
    ...
    CONSTRAINT [RB27_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB27_Doku__Ident__6AD0B01E] CHECK ([IdentyfikatorRekordu]<>(0))
