CREATE TABLE [zef2].[Bilans_Dokument] (
    ...
    CONSTRAINT [Bilans_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__Bilans_Do__Ident__5B8E6C8E] CHECK ([IdentyfikatorRekordu]<>(0))
