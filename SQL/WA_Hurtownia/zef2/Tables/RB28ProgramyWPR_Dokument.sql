CREATE TABLE [zef2].[RB28ProgramyWPR_Dokument] (
    ...
    CONSTRAINT [RB28ProgramyWPR_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB28Progr__Ident__7271D1E6] CHECK ([IdentyfikatorRekordu]<>(0))
