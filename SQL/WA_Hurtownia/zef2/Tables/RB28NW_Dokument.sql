CREATE TABLE [zef2].[RB28NW_Dokument] (
    ...
    CONSTRAINT [RB28NW_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB28NW_Do__Ident__6EA14102] CHECK ([IdentyfikatorRekordu]<>(0))
