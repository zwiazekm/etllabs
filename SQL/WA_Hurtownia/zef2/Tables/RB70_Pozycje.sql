CREATE TABLE [zef2].[RB70_Pozycje] (
    ...
    [PrzecietneWykonanieWokresieSprawozdaw] NUMERIC (32, 16) NOT NULL,
    [StanNaKoniecOkresuSprawodaw]           NUMERIC (32, 16) NOT NULL,
    [PlanOsoboweUposazenia]                 NUMERIC (32, 16) NOT NULL,
    [PlanDodatkoweWynagrodzenieRoczne]      NUMERIC (32, 16) NOT NULL,
    [WykonanieOsoboweUposazenia]            NUMERIC (32, 16) NOT NULL,
    [DodatkoweWynagrodzenieRoczne]          NUMERIC (32, 16) NOT NULL,
    ...
    CONSTRAINT [RB70_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC) ON [FG_ZEF2],
