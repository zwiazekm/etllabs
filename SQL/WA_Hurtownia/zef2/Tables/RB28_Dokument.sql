CREATE TABLE [zef2].[RB28_Dokument] (
    ...
    CONSTRAINT [RB28_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB28_Doku__Ident__6CB8F890] CHECK ([IdentyfikatorRekordu]<>(0))
