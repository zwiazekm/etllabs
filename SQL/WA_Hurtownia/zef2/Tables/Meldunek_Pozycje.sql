CREATE TABLE [zef2].[Meldunek_Pozycje] (
    ...
    [StanNaTenMiesiac]                  NUMERIC (32, 16) NOT NULL,
    [StanNarastajaco]                   NUMERIC (32, 16) NOT NULL,
    ...
    CONSTRAINT [Meldunek_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC) ON [FG_ZEF2]
);
