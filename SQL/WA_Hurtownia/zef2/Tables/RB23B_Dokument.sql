CREATE TABLE [zef2].[RB23B_Dokument] (
    ...
    CONSTRAINT [RB23B_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB23B_Dok__Ident__68E867AC] CHECK ([IdentyfikatorRekordu]<>(0))
