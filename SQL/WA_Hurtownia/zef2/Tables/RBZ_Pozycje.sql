CREATE TABLE [zef2].[RBZ_Pozycje] (
    ...
    [KwotaZadluzeniaOgolem]             NUMERIC (32, 16) NOT NULL,
    ...
    [InstytNiekomercNaRzeczGospodDom]   NUMERIC (32, 16) NOT NULL,
    ...
    CONSTRAINT [RBZ_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC) ON [FG_ZEF2]
);
