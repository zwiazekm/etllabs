CREATE TABLE [zef2].[RBWSB_Dokument] (
    ...
    CONSTRAINT [RBWSB_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RBWSB_Dok__Ident__7A12F3AE] CHECK ([IdentyfikatorRekordu]<>(0))
