CREATE TABLE [zef2].[SC4_Pozycje] (
    [Opis]                              NVARCHAR (250)   NOT NULL,
    [NumerWiersza]                      NUMERIC (32, 16) NOT NULL,
    [Paragraf4010]                      NUMERIC (32, 16) NOT NULL,
    [Paragraf4020]                      NUMERIC (32, 16) NOT NULL,
    [Paragraf4050]                      NUMERIC (32, 16) NOT NULL,
    [Paragraf4060]                      NUMERIC (32, 16) NOT NULL,
    [LiczbaFunkcjonariuszy]             NUMERIC (32, 16) NOT NULL,
    [LiczbaWyplaconychSwiadczen]        NUMERIC (32, 16) NOT NULL,
    ...
    CONSTRAINT [SC4_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC) ON [FG_ZEF2]
);
