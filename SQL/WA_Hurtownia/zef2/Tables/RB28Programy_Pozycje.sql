CREATE TABLE [zef2].[RB28Programy_Pozycje] (
    [UtworzonePrzez]                    NVARCHAR (8)     NOT NULL,
    [Opis]                              NVARCHAR (250)   NOT NULL,
    [NumerWiersza]                      NUMERIC (32, 16) NOT NULL,
    [PlanPoZmianachUE]                  NUMERIC (32, 16) NOT NULL,
    [PlanPoZmianachBP]                  NUMERIC (32, 16) NOT NULL,
    [ZaangazowanieUE]                   NUMERIC (32, 16) NOT NULL,
    [ZaangazowanieBP]                   NUMERIC (32, 16) NOT NULL,
    [WykonanieWydatkowUE]               NUMERIC (32, 16) NOT NULL,
    [WykonanieWydatkowBP]               NUMERIC (32, 16) NOT NULL,
    ...
    CONSTRAINT [RB28Programy_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC) ON [FG_ZEF2],
