CREATE TABLE [zef2].[RB23A_Dokument] (
    ...
    CONSTRAINT [RB23A_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB23A_Dok__Ident__67001F3A] CHECK ([IdentyfikatorRekordu]<>(0))
