CREATE TABLE [zef2].[RB28UEWPR_Dokument] (
    ...
    CONSTRAINT [RB28UEWPR_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC) ON [FG_ZEF2],
    CONSTRAINT [CK__RB28UEWPR__Ident__764262CA] CHECK ([IdentyfikatorRekordu]<>(0))
