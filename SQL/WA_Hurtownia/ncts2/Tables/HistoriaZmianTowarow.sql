CREATE TABLE [ncts2].[HistoriaZmianTowarow] (
    ...
    CONSTRAINT [HistoriaZmianTowarow_pk] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_NCTS2],
    CONSTRAINT [HistoriaZmianTowarow_IdOperacjiTranzytowej_OperacjeTranzytowe_fk] FOREIGN KEY ([IdOperacjiTranzytowej]) REFERENCES [ncts2].[OperacjeTranzytowe] ([Id])
);
