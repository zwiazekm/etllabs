CREATE TABLE [ncts2].[UwagiRozladunkowe] (
    ...
    CONSTRAINT [UwagiRozladunkowe_pk] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_NCTS2],
    CONSTRAINT [UwagiRozladunkowe_IdOperacjiTranzytowej_OperacjeTranzytowe_fk] FOREIGN KEY ([IdOperacjiTranzytowej]) REFERENCES [ncts2].[OperacjeTranzytowe] ([Id])
