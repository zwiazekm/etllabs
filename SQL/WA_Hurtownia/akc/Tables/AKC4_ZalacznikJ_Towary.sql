CREATE TABLE [akc].[AKC4_ZalacznikJ_Towary] (
    ...
    CONSTRAINT [PK_AKC4_ZalacznikJ_Towary] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC, [NumerPozycji] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC4_ZalacznikJ_Towary_IdDokNumerZalacznikaSys_AKC4_ZalacznikJ_IdDokNumerZalacznikaSys] FOREIGN KEY ([IdDok], [NumerZalacznikaSys]) REFERENCES [akc].[AKC4_ZalacznikJ] ([IdDok], [NumerZalacznikaSys])
);
