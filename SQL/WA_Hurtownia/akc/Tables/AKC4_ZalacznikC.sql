CREATE TABLE [akc].[AKC4_ZalacznikC] (
    ...
    [Okres]                     DATE            NULL,
    CONSTRAINT [PK_AKC4_ZalacznikC] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC4_ZalacznikC_IdDok_AKC4_Deklaracja_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [akc].[AKC4_Deklaracja] ([IdDok])
);
