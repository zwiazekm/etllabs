CREATE TABLE [akc].[INF_Informacja_D] (
    ...
    CONSTRAINT [PK_INF_Informacja_D] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznika] ASC) ON [FG_AKC],
    CONSTRAINT [FK_INF_Informacja_D_IdKomorkiIdPodmiotu_Podmiot_IdKomorkiIdPodmiotu] FOREIGN KEY ([IdKomorki], [IdPodmiotu]) REFERENCES [akc].[Podmiot] ([IdKomorki], [IdPodmiotu])
);
