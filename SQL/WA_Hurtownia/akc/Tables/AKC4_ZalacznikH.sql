CREATE TABLE [akc].[AKC4_ZalacznikH] (
    ...
    [Okres]                                   DATE            NULL,
    [OkresDo]                                 DATE            NULL,
    CONSTRAINT [PK_AKC4_ZalacznikH] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC4_ZalacznikH_IdDok_AKC4_Deklaracja_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [akc].[AKC4_Deklaracja] ([IdDok])
);
