CREATE TABLE [akc].[AKC4_ZalacznikF] (
    ...
    [Okres]                           DATE            NULL,
    CONSTRAINT [PK_AKC4_ZalacznikF] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC4_ZalacznikF_IdDok_AKC4_Deklaracja_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [akc].[AKC4_Deklaracja] ([IdDok])
);
