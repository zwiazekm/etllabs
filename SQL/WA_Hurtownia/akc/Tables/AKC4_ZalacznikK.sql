CREATE TABLE [akc].[AKC4_ZalacznikK] (
    ...
    [Okres]                     DATE            NULL,
    CONSTRAINT [PK_AKC4_ZalacznikK] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC4_ZalacznikK_IdDok_AKC4_Deklaracja_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [akc].[AKC4_Deklaracja] ([IdDok])
);
