CREATE TABLE [akc].[AKC3_PodatekWedlugGrup] (
    ...
    CONSTRAINT [PK_AKC3_PodatekWedlugGrup] PRIMARY KEY CLUSTERED ([IdDok] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC3_PodatekWedlugGrup_IdDok_AKC3_Deklaracja_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [akc].[AKC3_Deklaracja] ([IdDok])
);
