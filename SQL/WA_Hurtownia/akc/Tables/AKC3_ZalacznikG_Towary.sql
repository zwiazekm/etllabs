CREATE TABLE [akc].[AKC3_ZalacznikG_Towary] (
    ...
    CONSTRAINT [PK_AKC3_ZalacznikG_Towary] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC, [NumerPozycji] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC3_ZalacznikG_Towary_IdDokNumerZalacznikaSys_AKC3_ZalacznikG_IdDokNumerZalacznikaSys] FOREIGN KEY ([IdDok], [NumerZalacznikaSys]) REFERENCES [akc].[AKC3_ZalacznikG] ([IdDok], [NumerZalacznikaSys])
);
