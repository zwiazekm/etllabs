CREATE TABLE [akc].[AKC3_ZalacznikD_Towary] (
    ...
    CONSTRAINT [PK_AKC3_ZalacznikD_Towary] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC, [NumerPozycji] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC3_ZalacznikD_Towary_IdDokNumerZalacznikaSys_AKC3_ZalacznikD_IdDokNumerZalacznikaSys] FOREIGN KEY ([IdDok], [NumerZalacznikaSys]) REFERENCES [akc].[AKC3_ZalacznikD] ([IdDok], [NumerZalacznikaSys])
);
