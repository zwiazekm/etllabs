CREATE TABLE [akc].[AKC3_ZalacznikC_Towary] (
    ...
    CONSTRAINT [PK_AKC3_ZalacznikC_Towary] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC, [NumerPozycji] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC3_ZalacznikC_Towary_IdDokNumerZalacznikaSys_AKC3_ZalacznikC_IdDokNumerZalacznikaSys] FOREIGN KEY ([IdDok], [NumerZalacznikaSys]) REFERENCES [akc].[AKC3_ZalacznikC] ([IdDok], [NumerZalacznikaSys])
);
