CREATE TABLE [akc].[AKCST_Towary] (
    ...
    CONSTRAINT [PK_AKCST_Towary] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerPozycji] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKCST_Towary_IdDok_AKCST_Deklaracja_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [akc].[AKCST_Deklaracja] ([IdDok])
);
