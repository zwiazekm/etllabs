CREATE TABLE [akc].[AKC4_ZalacznikK_Towary] (
    ...
    CONSTRAINT [PK_AKC4_ZalacznikK_Towary] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC, [NumerPozycji] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC4_ZalacznikK_Towary_IdDokNumerZalacznikaSys_AKC4_ZalacznikK_IdDokNumerZalacznikaSys] FOREIGN KEY ([IdDok], [NumerZalacznikaSys]) REFERENCES [akc].[AKC4_ZalacznikK] ([IdDok], [NumerZalacznikaSys])
);
