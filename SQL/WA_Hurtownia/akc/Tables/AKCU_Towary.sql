CREATE TABLE [akc].[AKCU_Towary] (
    ...
    CONSTRAINT [PK_AKCU_Towary] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerPozycji] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKCU_Towary_IdDok_AKCU_Deklaracja_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [akc].[AKCU_Deklaracja] ([IdDok])
);
