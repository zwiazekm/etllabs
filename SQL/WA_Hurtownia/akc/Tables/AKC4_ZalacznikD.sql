CREATE TABLE [akc].[AKC4_ZalacznikD] (
    ...
    [Okres]                     DATE            NULL,
    CONSTRAINT [PK_AKC4_ZalacznikD] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerZalacznikaSys] ASC) ON [FG_AKC],
    CONSTRAINT [FK_AKC4_ZalacznikD_IdDok_AKC4_Deklaracja_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [akc].[AKC4_Deklaracja] ([IdDok])
);
