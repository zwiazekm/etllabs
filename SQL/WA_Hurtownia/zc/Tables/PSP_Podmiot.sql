CREATE TABLE [zc].[PSP_Podmiot] (
    ...
    CONSTRAINT [PK_PSP_Podmiot] PRIMARY KEY CLUSTERED ([IdDok] ASC, [Typ] ASC, [IdPozycji] ASC) ON [FG_ZC],
    CONSTRAINT [FK_PSP_Podmiot_IdDok_PSP_Dokument_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [zc].[PSP_Dokument] ([IdDok])
);
