CREATE TABLE [zc].[INNY_Towar] (
    ...
    CONSTRAINT [PK_INNY_Towar] PRIMARY KEY CLUSTERED ([IdDok] ASC, [IdPozycji] ASC) ON [FG_ZC],
    CONSTRAINT [FK_INNY_Towar_IdDok_INNY_Dokument_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [zc].[INNY_Dokument] ([IdDok])
);
