CREATE TABLE [zc].[ST_DanePrzywozuWywozu] (
    ...
    CONSTRAINT [PK_ST_DanePrzywozuWywozu] PRIMARY KEY CLUSTERED ([IdDok] ASC, [Typ] ASC) ON [FG_ZC],
    CONSTRAINT [FK_ST_DanePrzywozuWywozu_IdDok_ST_Dokument_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [zc].[ST_Dokument] ([IdDok])
);
