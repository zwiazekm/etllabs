CREATE TABLE [zc].[ST_Podmiot] (
    ...
    CONSTRAINT [PK_ST_Podmiot] PRIMARY KEY CLUSTERED ([IdDok] ASC, [Typ] ASC, [IdPozycji] ASC) ON [FG_ZC],
    CONSTRAINT [FK_ST_Podmiot_IdDok_ST_Dokument_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [zc].[ST_Dokument] ([IdDok])
);
