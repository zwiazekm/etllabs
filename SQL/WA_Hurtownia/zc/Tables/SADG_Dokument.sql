CREATE TABLE [zc].[SADG_Dokument] (
    ...
    CONSTRAINT [PK_SADG_Dokument] PRIMARY KEY CLUSTERED ([IdDok] ASC) ON [FG_ZC],
    CONSTRAINT [FK_SADG_Dokument_JednWyjsciaIdPid] FOREIGN KEY ([JednWyjsciaIdPid]) REFERENCES [pdr].[c001] ([c001_id])
);
