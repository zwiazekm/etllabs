CREATE TABLE [emcs2].[AD_MiejsceOdbioru] (
    ...
    [PodmiotNRA]  VARCHAR (13)   COLLATE Polish_CS_AS NOT NULL,
    ...
    CONSTRAINT [AD_MiejsceOdbioru$PK_AD_MiejsceOdbioru] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_EMCS2],
    CONSTRAINT [FK_AD_MiejsceOdbioru] FOREIGN KEY ([PodmiotNRA], [PodmiotTyp]) REFERENCES [emcs2].[AD_Podmiot] ([NRA], [Typ])
);
