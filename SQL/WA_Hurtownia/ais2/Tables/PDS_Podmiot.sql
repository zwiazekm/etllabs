CREATE TABLE [ais2].[PDS_Podmiot] (
    ...
    CONSTRAINT [PDS_Podmiot$PK_PDS_Podmiot] PRIMARY KEY CLUSTERED ([Id] ASC) ON [FG_AIS2],
    CONSTRAINT [FK__PDS_Podmiot_IdDokPDS__PDS_Dokument_id] FOREIGN KEY ([IdDokPDS]) REFERENCES [ais2].[PDS_Dokument] ([Id])
);
