CREATE TABLE [zef2DW].[USAD_Dokument] (
    ...
    [NrZgloszeniaNiekompletnego]                NVARCHAR (255)  NULL,
    ...
    [KwotaDoZaplatyZwrotu]                      DECIMAL (19, 2) NULL,
    ...
    [NIPKontrahentaZabezpieczeniaJednorazowego] NVARCHAR (12)   NULL,
    [DataArch]                                  DATE            NULL,
    [ID_Pismo_xml]                              BIGINT          NULL,
    [IdentyfikatorPodatnika]                    BIGINT          NOT NULL,
    [DataRejestracjiRDC]                        DATE            NULL,
    CONSTRAINT [USAD_Dokument_PK] PRIMARY KEY CLUSTERED ([IdentyfikatorDokumentu] ASC) ON [FG_ZEF2DW]
