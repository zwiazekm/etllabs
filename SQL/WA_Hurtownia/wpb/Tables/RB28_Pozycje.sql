CREATE TABLE [wpb].[RB28_Pozycje] (
    ...
    CONSTRAINT [PK_RB28_Pozycje] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerPozycji] ASC) ON [FG_WPB],
    CONSTRAINT [FK_RB28_Pozycje_IdDok_RB28_Dokument_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [wpb].[RB28_Dokument] ([IdDok])
);
