CREATE TABLE [wpb].[RB70_Pozycje] (
    ...
    CONSTRAINT [PK_RB70_Pozycje] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerPozycji] ASC) ON [FG_WPB],
    CONSTRAINT [FK_RB70_Pozycje_IdDok_RB70_Dokument_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [wpb].[RB70_Dokument] ([IdDok])
);
