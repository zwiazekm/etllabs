CREATE TABLE [wpb].[RB27_Pozycje] (
    ...
    CONSTRAINT [PK_RB27_Pozycje] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerPozycji] ASC) ON [FG_WPB],
    CONSTRAINT [FK_RB27_Pozycje_IdDok_RB27_Dokument_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [wpb].[RB27_Dokument] ([IdDok])
);
