CREATE TABLE [wpb].[RB28UE_Pozycje] (
    ...
    CONSTRAINT [PK_RB28UE_Pozycje] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerPozycji] ASC) ON [FG_WPB],
    CONSTRAINT [FK_RB28UE_Pozycje_IdDok_RB28UE_Dokument_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [wpb].[RB28UE_Dokument] ([IdDok])
);
