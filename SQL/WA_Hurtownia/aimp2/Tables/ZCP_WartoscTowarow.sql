CREATE TABLE [aimp2].[ZCP_WartoscTowarow] (
    ...
    CONSTRAINT [ZCP_WartoscTowarow_PK] PRIMARY KEY CLUSTERED ([IdWpisu] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_WartoscTowarow$FK_ZCP_Towar] FOREIGN KEY ([IdTowarZCP]) REFERENCES [aimp2].[ZCP_Towar] ([IdPozycji])
);
