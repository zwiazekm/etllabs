CREATE TABLE [aimp2].[DPDZ_DokumentWymagany] (
    ...
    CONSTRAINT [DPDZ_DokumentWymagany_PK] PRIMARY KEY CLUSTERED ([IdDokWym] ASC) ON [FG_AIMP2],
    CONSTRAINT [DPDZ_DokumentWymagany$FK_DPDZ_Towar] FOREIGN KEY ([IdTowarDPDZ]) REFERENCES [aimp2].[DPDZ_Towar] ([IdPozycji])
