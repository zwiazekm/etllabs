CREATE TABLE [aimp2].[ZCP_InformacjaWDZ] (
    ...
    CONSTRAINT [ZCP_InformacjaWDZ_PK] PRIMARY KEY CLUSTERED ([IdInformacji] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_InformacjaWDZ$FK_ZCP_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[ZCP_Dokument] ([IdDok])
);
