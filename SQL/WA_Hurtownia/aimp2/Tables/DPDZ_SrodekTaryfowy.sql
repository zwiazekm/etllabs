CREATE TABLE [aimp2].[DPDZ_SrodekTaryfowy] (
    ...
    CONSTRAINT [DPDZ_SrodekTaryfowy_PK] PRIMARY KEY CLUSTERED ([IdWpisu] ASC) ON [FG_AIMP2],
    CONSTRAINT [DPDZ_SrodekTaryfowy$FK_DPDZ_Towar] FOREIGN KEY ([IdTowarDPDZ]) REFERENCES [aimp2].[DPDZ_Towar] ([IdPozycji])
);
