CREATE TABLE [aimp2].[ZCP_Towar] (
    ...
    CONSTRAINT [ZCP_Towar_PK] PRIMARY KEY CLUSTERED ([IdPozycji] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_Towar$FK_ZCP_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[ZCP_Dokument] ([IdDok]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_OsobaFizyczna] FOREIGN KEY ([IdSprzedajacegoOsobaFizyczna]) REFERENCES [aimp2].[ZCP_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_OsobaFizyczna__IdKupujacegoPodmiotGospodarczy] FOREIGN KEY ([IdKupujacegoPodmiotGospodarczy]) REFERENCES [aimp2].[ZCP_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_OsobaFizyczna__IdNadawcyOsobaFizyczna] FOREIGN KEY ([IdNadawcyOsobaFizyczna]) REFERENCES [aimp2].[ZCP_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_OsobaFizyczna__IdOdbiorcyOsobaFizyczna] FOREIGN KEY ([IdOdbiorcyOsobaFizyczna]) REFERENCES [aimp2].[ZCP_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_OsobaFizyczna__IdOsobyDoKontaktu] FOREIGN KEY ([IdOsobyDoKontaktu]) REFERENCES [aimp2].[ZCP_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_Podmiot] FOREIGN KEY ([IdSprzedajacegoPodmiotGospodarczy]) REFERENCES [aimp2].[ZCP_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_Podmiot__IdKupujacegoOsobaFizyczna] FOREIGN KEY ([IdKupujacegoOsobaFizyczna]) REFERENCES [aimp2].[ZCP_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_Podmiot__IdNadawcyPodmiotGospodarczy] FOREIGN KEY ([IdNadawcyPodmiotGospodarczy]) REFERENCES [aimp2].[ZCP_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_Podmiot__IdOdbiorcyPodmiotGospodarczy] FOREIGN KEY ([IdOdbiorcyPodmiotGospodarczy]) REFERENCES [aimp2].[ZCP_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_Podmiot__IdPodmiotuDoKontaktu] FOREIGN KEY ([IdPodmiotuDoKontaktu]) REFERENCES [aimp2].[ZCP_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [ZCP_Towar$FK_ZCP_Towar$FK_ZCP_Dokument_UZP] FOREIGN KEY ([IdZgloszeniaUzupelniajacego]) REFERENCES [aimp2].[ZCP_Dokument] ([IdDok])
) TEXTIMAGE_ON [FG_AIMP2];


GO
ALTER TABLE [aimp2].[ZCP_Towar] NOCHECK CONSTRAINT [ZCP_Towar$FK_ZCP_Towar$FK_ZCP_Dokument_UZP];
