CREATE TABLE [aimp2].[DPDZ_Towar] (
    ...
    [TowarStrategiczny]                      BIT             NOT NULL,
    [EAD]                                    BIT             NOT NULL,
    ...
    CONSTRAINT [DPDZ_Towar_PK] PRIMARY KEY CLUSTERED ([IdPozycji] ASC) ON [FG_AIMP2],
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_Dokument_UZP] FOREIGN KEY ([IdZgloszeniaUzupelniajacego]) REFERENCES [aimp2].[DPDZ_Dokument] ([IdDok]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_Dokument_ZCP] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[DPDZ_Dokument] ([IdDok]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_OsobaFizyczna__IdKupujacegoPodmiotGospodarczy] FOREIGN KEY ([IdKupujacegoPodmiotGospodarczy]) REFERENCES [aimp2].[DPDZ_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_OsobaFizyczna__IdNadawcyOsobaFizyczna] FOREIGN KEY ([IdNadawcyOsobaFizyczna]) REFERENCES [aimp2].[DPDZ_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_OsobaFizyczna__IdOdbiorcyOsobaFizyczna] FOREIGN KEY ([IdOdbiorcyOsobaFizyczna]) REFERENCES [aimp2].[DPDZ_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_OsobaFizyczna__IdOsobyDoKontaktu] FOREIGN KEY ([IdOsobyDoKontaktu]) REFERENCES [aimp2].[DPDZ_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_OsobaFizyczna__IdSprzedajacegoOsobaFizyczna] FOREIGN KEY ([IdSprzedajacegoOsobaFizyczna]) REFERENCES [aimp2].[DPDZ_OsobaFizyczna] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_Podmiot__IdKupujacegoOsobaFizyczna] FOREIGN KEY ([IdKupujacegoOsobaFizyczna]) REFERENCES [aimp2].[DPDZ_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_Podmiot__IdNadawcyPodmiotGospodarczy] FOREIGN KEY ([IdNadawcyPodmiotGospodarczy]) REFERENCES [aimp2].[DPDZ_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_Podmiot__IdOdbiorcyPodmiotGospodarczy] FOREIGN KEY ([IdOdbiorcyPodmiotGospodarczy]) REFERENCES [aimp2].[DPDZ_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_Podmiot__IdPodmiotuDoKontaktu] FOREIGN KEY ([IdPodmiotuDoKontaktu]) REFERENCES [aimp2].[DPDZ_Podmiot] ([IdKontrahenta]),
    CONSTRAINT [DPDZ_Towar$FK_DPDZ_Podmiot__IdSprzedajacegoPodmiotGospodarczy] FOREIGN KEY ([IdSprzedajacegoPodmiotGospodarczy]) REFERENCES [aimp2].[DPDZ_Podmiot] ([IdKontrahenta])
) TEXTIMAGE_ON [FG_AIMP2];


GO
ALTER TABLE [aimp2].[DPDZ_Towar] NOCHECK CONSTRAINT [DPDZ_Towar$FK_DPDZ_Dokument_UZP];
