CREATE TABLE [aimp2].[PWD_Dokument] (
    ...
    [VAT7]                               TINYINT         NULL,
    [PowodAnulowaniaZgloszenia]          NVARCHAR (1024) NULL,
    [CzasNaPrzeslaniePowiadomPrzywoz]    NUMERIC (4)     NULL,
    [CzasNaPrzeslaniePowiadomPrzybycie]  NUMERIC (4)     NULL,
    [OczekujeNaIE025]                    NUMERIC (1)     NULL,
    [JednostkaCzasuDecyzjePrzywoz]       NVARCHAR (50)   NULL,
    [JednostkaCzasuPowiadomPrzybycie]    NVARCHAR (50)   NULL,
    [WyslanoZgloszenieTQS]               BIT             NULL,
    CONSTRAINT [PWD_Dokument_PK] PRIMARY KEY CLUSTERED ([IdDok] ASC) ON [FG_AIMP2]
