CREATE TABLE [aimp2].[ZCP_Podmiot] (
    ...
    CONSTRAINT [ZCP_Podmiot_PK] PRIMARY KEY CLUSTERED ([IdKontrahenta] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_Podmiot$FK_ZCP_PodmiotAdres] FOREIGN KEY ([IdAdresu]) REFERENCES [aimp2].[ZCP_PodmiotAdres] ([IdAdresu]),
    CONSTRAINT [ZCP_Podmiott$FK_ZCP_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[ZCP_Dokument] ([IdDok])
);
