CREATE TABLE [aimp2].[ZCP_InformacjaPOD] (
    ...
    CONSTRAINT [ZCP_InformacjaPOD_PK] PRIMARY KEY CLUSTERED ([IdInformacji] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_InformacjaPOD$FK_ZCP_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[ZCP_Dokument] ([IdDok])
);
