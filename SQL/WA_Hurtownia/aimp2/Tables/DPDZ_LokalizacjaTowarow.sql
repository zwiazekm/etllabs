CREATE TABLE [aimp2].[DPDZ_LokalizacjaTowarow] (
    ...
    CONSTRAINT [DPDZ_LokalizacjaTowarow_PK] PRIMARY KEY CLUSTERED ([IdLokalizacji] ASC) ON [FG_AIMP2],
    CONSTRAINT [DPDZ_LokalizacjaTowarow$FK_DPDZ_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[DPDZ_Dokument] ([IdDok])
);
