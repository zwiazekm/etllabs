CREATE TABLE [aimp2].[DSK_LokalizacjaTowarow] (
    ...
    CONSTRAINT [DSK_LokalizacjaTowarow_PK] PRIMARY KEY CLUSTERED ([IdLokalizacji] ASC) ON [FG_AIMP2],
    CONSTRAINT [DSK_LokalizacjaTowarow$FK_DSK_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[DSK_Dokument] ([IdDok])
);
