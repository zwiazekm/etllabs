CREATE TABLE [aimp2].[ZCP_MetodaPlatnosci] (
    ...
    CONSTRAINT [ZCP_MetodaPlatnosci_PK] PRIMARY KEY CLUSTERED ([IdMetodyPlatnosci] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_MetodaPlatnosci$FK_ZCP_InformacjaPODZ] FOREIGN KEY ([IdPODZ]) REFERENCES [aimp2].[ZCP_InformacjaPODZ] ([IdInformacji]),
    CONSTRAINT [ZCP_MetodaPlatnosci$FK_ZCP_Towar] FOREIGN KEY ([IdTowarZCP]) REFERENCES [aimp2].[ZCP_Towar] ([IdPozycji])
