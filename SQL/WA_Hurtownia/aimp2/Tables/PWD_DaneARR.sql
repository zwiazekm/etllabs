CREATE TABLE [aimp2].[PWD_DaneARR] (
    ...
    CONSTRAINT [PWD_DaneARR_PK] PRIMARY KEY CLUSTERED ([IdWpisu] ASC) ON [FG_AIMP2],
    CONSTRAINT [PWD_DaneARR$FK_PWD_Towar] FOREIGN KEY ([IdTowarPWD]) REFERENCES [aimp2].[PWD_Towar] ([IdPozycji])
);
