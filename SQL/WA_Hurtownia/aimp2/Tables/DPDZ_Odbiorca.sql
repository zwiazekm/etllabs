CREATE TABLE [aimp2].[DPDZ_Odbiorca] (
    ...
    CONSTRAINT [DPDZ_Odbiorca_PK] PRIMARY KEY CLUSTERED ([IdKontrahenta] ASC) ON [FG_AIMP2],
    CONSTRAINT [DPDZ_Odbiorca$FK_DPDZ_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[DPDZ_Dokument] ([IdDok])
);
