CREATE TABLE [aimp2].[PWD_TransportNaGranicy] (
    ...
    CONSTRAINT [PWD_TransportNaGranicy_PK] PRIMARY KEY CLUSTERED ([IdTransportu] ASC) ON [FG_AIMP2],
    CONSTRAINT [PWD_TransportNaGranicy$FK_PWD_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[PWD_Dokument] ([IdDok])
);
