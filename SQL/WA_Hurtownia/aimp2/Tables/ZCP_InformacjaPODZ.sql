CREATE TABLE [aimp2].[ZCP_InformacjaPODZ] (
    ...
    CONSTRAINT [ZCP_InformacjaPODZ_PK] PRIMARY KEY CLUSTERED ([IdInformacji] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_InformacjaPODZ$FK_ZCP_Towar] FOREIGN KEY ([IdTowarZCP]) REFERENCES [aimp2].[ZCP_Towar] ([IdPozycji])
);
