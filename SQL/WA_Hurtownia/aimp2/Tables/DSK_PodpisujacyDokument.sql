CREATE TABLE [aimp2].[DSK_PodpisujacyDokument] (
    ...
    CONSTRAINT [DSK_PodpisujacyDokument_PK] PRIMARY KEY CLUSTERED ([IdPodpisujacego] ASC) ON [FG_AIMP2],
    CONSTRAINT [DSK_PodpisujacyDokument$FK_DSK_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[DSK_Dokument] ([IdDok])
