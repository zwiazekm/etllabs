CREATE TABLE [aimp2].[ZCP_SrodekTaryfowy] (
    ...
    CONSTRAINT [ZCP_SrodekTaryfowy_PK] PRIMARY KEY CLUSTERED ([IdWpisu] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_SrodekTaryfowy$FK_ZCP_Towar] FOREIGN KEY ([IdTowarZCP]) REFERENCES [aimp2].[ZCP_Towar] ([IdPozycji])
);
