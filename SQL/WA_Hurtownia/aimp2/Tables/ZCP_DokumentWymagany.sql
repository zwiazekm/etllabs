CREATE TABLE [aimp2].[ZCP_DokumentWymagany] (
    ...
    CONSTRAINT [ZCP_DokumentWymagany_PK] PRIMARY KEY CLUSTERED ([IdDokWym] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_DokumentWymagany$FK_ZCP_Towar] FOREIGN KEY ([IdTowarZCP]) REFERENCES [aimp2].[ZCP_Towar] ([IdPozycji])
