CREATE TABLE [aimp2].[ZCP_TransportNaGranicy] (
    ...
    CONSTRAINT [ZCP_TransportNaGranicy_PK] PRIMARY KEY CLUSTERED ([IdTransportu] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_TransportNaGranicy$FK_ZCP_Dokument] FOREIGN KEY ([IdDok]) REFERENCES [aimp2].[ZCP_Dokument] ([IdDok])
);
