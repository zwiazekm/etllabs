CREATE TABLE [aimp2].[ZCP_TowarInformacjaWDZ] (
    ...
    CONSTRAINT [ZCP_TowarInformacjaWDZ_PK] PRIMARY KEY CLUSTERED ([IdInformacji] ASC) ON [FG_AIMP2],
    CONSTRAINT [ZCP_TowarInformacjaWDZ$FK_ZCP_TowarInformacjaWDZ] FOREIGN KEY ([IdTowarZCP]) REFERENCES [aimp2].[ZCP_Towar] ([IdPozycji])
);
