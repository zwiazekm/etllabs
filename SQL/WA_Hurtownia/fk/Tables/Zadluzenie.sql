CREATE TABLE [fk].[Zadluzenie] (
    ...
    CONSTRAINT [PK_Zadluzenie] PRIMARY KEY CLUSTERED ([IdDok] ASC) ON [FG_FK],
    CONSTRAINT [FK_Zadluzenie_IdPodmiotuIdKomorki_Podmiot_IdPodmiotuIdKomorki] FOREIGN KEY ([IdPodmiotu], [IdKomorki]) REFERENCES [fk].[Podmiot] ([IdPodmiotu], [IdKomorki])
);
