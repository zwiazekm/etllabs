CREATE TABLE [fk].[ZestawienieWZPW] (
    ...
    CONSTRAINT [PK_ZestawienieWZPW] PRIMARY KEY CLUSTERED ([IdDok] ASC, [NumerPozycji] ASC) ON [FG_FK],
    CONSTRAINT [FK_ZestawienieWZPW_IdDok_SprawozdanieMeldunkowe_IdDok] FOREIGN KEY ([IdDok]) REFERENCES [fk].[SprawozdanieMeldunkowe] ([IdDok])
);
