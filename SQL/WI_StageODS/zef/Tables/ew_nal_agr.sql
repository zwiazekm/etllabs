CREATE TABLE [zef].[ew_nal_agr] (
    ...
    [kwota_dok]      NUMERIC (20, 2) NULL,
    [kwota_nal]      NUMERIC (20, 2) NULL,
    [kwota_wpl]      NUMERIC (20, 2) NULL,
    ...
    CONSTRAINT [PK_EW_NAL_AGR] PRIMARY KEY CLUSTERED ([id_dok] ASC, [id_komor] ASC, [id_kontr] ASC)
);
