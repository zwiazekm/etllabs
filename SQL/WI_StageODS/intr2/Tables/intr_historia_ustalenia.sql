CREATE TABLE [intr2].[intr_historia_ustalenia] (
    ...
    CONSTRAINT [intr_historia_ustalenia$PK_INTR_HISTORIA_USTALENIA] PRIMARY KEY CLUSTERED ([nr_ustalenia] ASC, [nr_zmiany] ASC, [nip] ASC, [rok] ASC, [miesiac] ASC, [typ] ASC)
);
