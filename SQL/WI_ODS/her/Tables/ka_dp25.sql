CREATE TABLE [her].[ka_dp25] (
    ...
    [wsk_nr_kol] INT           NULL,
    CONSTRAINT [PK_ka_dp25] PRIMARY KEY CLUSTERED ([tr] ASC, [kod] ASC) ON [FG_HER]
);


GO
CREATE NONCLUSTERED INDEX [IX_ka_dp25]
    ON [her].[ka_dp25]([tr] ASC)
    ON [FG_HER];


GO
CREATE NONCLUSTERED INDEX [IX_ka_dp25_1]
    ON [her].[ka_dp25]([kod] ASC)
    ON [FG_HER];


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_ka_dp25_2]
    ON [her].[ka_dp25]([id] ASC)
    ON [FG_HER];
