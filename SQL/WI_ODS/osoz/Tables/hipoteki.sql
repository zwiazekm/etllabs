CREATE TABLE [osoz].[hipoteki] (
    ...
    CONSTRAINT [PK__hipoteki__3213E83F8EDB88EC] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_OSOZ],
    CONSTRAINT [UQ__hipoteki__C9F82A544CA7AD91] UNIQUE NONCLUSTERED ([numer_ksiegi_wieczystej] ASC) ON [FG_OSOZ]
);
