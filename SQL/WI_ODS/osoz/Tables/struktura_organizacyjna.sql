CREATE TABLE [osoz].[struktura_organizacyjna] (
    ...
    CONSTRAINT [PK__struktur__3213E83F5D3A4053] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_OSOZ],
    CONSTRAINT [fk375d923cf470f466] FOREIGN KEY ([jednostka_nadrzedna_id]) REFERENCES [osoz].[struktura_organizacyjna] ([id])
);
