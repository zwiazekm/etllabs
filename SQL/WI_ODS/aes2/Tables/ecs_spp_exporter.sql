CREATE TABLE [aes2].[ecs_spp_exporter] (
    ...
    CONSTRAINT [ecs_spp_exporter$ecs_spp_ex_19513429851] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_spp_exporter$fk_exporter_decl_spp] FOREIGN KEY ([declcoexportsuppl_decl_id]) REFERENCES [aes2].[ecs_spp_declcoexpsuppl] ([decl_id])
);
