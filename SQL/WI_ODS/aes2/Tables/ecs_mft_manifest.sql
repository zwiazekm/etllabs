CREATE TABLE [aes2].[ecs_mft_manifest] (
    ...
    CONSTRAINT [ecs_mft_manifest$pk_ecs_mft_manifest] PRIMARY KEY CLUSTERED ([decl_id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_mft_manifest$fk_ecs_mft_manifest_customs_de] FOREIGN KEY ([decl_id]) REFERENCES [aes2].[customs_decl] ([id])
);
