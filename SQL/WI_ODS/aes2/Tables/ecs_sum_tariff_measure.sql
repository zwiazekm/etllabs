CREATE TABLE [aes2].[ecs_sum_tariff_measure] (
    ...
    CONSTRAINT [ecs_sum_tariff_measure$ecs_sum_ta_8974352401] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_sum_tariff_measure$fk_sum_tarif_measure_goods_ite] FOREIGN KEY ([goods_item_id]) REFERENCES [aes2].[ecs_sum_goods_item] ([id])
);
