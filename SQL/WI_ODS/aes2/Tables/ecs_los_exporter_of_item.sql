CREATE TABLE [aes2].[ecs_los_exporter_of_item] (
    ...
    CONSTRAINT [ecs_los_exporter_of_item$ecs_los_ex_21398676591] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_los_exporter_of_item$fk_los_item_los_goods_item] FOREIGN KEY ([goods_item_id]) REFERENCES [aes2].[ecs_los_goods_item] ([id])
);
