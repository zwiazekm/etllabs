CREATE TABLE [aes2].[aes_psw_item_req_doc] (
    ...
    CONSTRAINT [aes_psw_item_req_doc$pk_id] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [aes_psw_item_req_doc$fk_aes_psw_item] FOREIGN KEY ([psw_item_id]) REFERENCES [aes2].[aes_psw_item] ([id])
);
