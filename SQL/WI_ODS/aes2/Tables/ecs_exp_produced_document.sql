CREATE TABLE [aes2].[ecs_exp_produced_document] (
    ...
    CONSTRAINT [ecs_exp_produced_document$pk_ecs_exp_produced_document] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_exp_produced_document$fk_prod_document_goods_item] FOREIGN KEY ([goods_item_id]) REFERENCES [aes2].[ecs_exp_goods_item] ([id])
);
