CREATE TABLE [aes2].[ecs_sum_declarant] (
    ...
    CONSTRAINT [ecs_sum_declarant$ecs_sum_de_7374346701] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_sum_declarant$fk_declarant_sumdecl_co_exit] FOREIGN KEY ([sumdeclcoexit_decl_id]) REFERENCES [aes2].[ecs_sum_declcoexit] ([decl_id])
);
