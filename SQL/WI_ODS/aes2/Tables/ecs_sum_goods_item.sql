CREATE TABLE [aes2].[ecs_sum_goods_item] (
    ...
    CONSTRAINT [ecs_sum_goods_item$ecs_sum_go_8014348981] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_sum_goods_item$fk_goods_item_sumdecl_co_exit] FOREIGN KEY ([sumdeclcoexit_decl_id]) REFERENCES [aes2].[ecs_sum_declcoexit] ([decl_id])
);
