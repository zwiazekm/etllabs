CREATE TABLE [aes2].[ecs_followup] (
    ...
    [send_date]            DATE           NULL,
    CONSTRAINT [ecs_followup$ecs_follow_17746263342] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_followup$fk_fupexp_decl_co_exp] FOREIGN KEY ([declcoexport_decl_id]) REFERENCES [aes2].[ecs_exp_declcoexport] ([decl_id])
);
