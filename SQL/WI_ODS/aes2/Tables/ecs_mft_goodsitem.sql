CREATE TABLE [aes2].[ecs_mft_goodsitem] (
    ...
    CONSTRAINT [ecs_mft_goodsitem$pk_ecs_mft_goodsitem] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_mft_goodsitem$fk_goods_item_manifest] FOREIGN KEY ([manifest_decl_id]) REFERENCES [aes2].[ecs_mft_manifest] ([decl_id])
);
