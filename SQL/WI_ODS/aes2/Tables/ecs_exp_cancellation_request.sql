CREATE TABLE [aes2].[ecs_exp_cancellation_request] (
    ...
    CONSTRAINT [ecs_exp_cancellation_request$pk_ecs_exp_cancellation_reques] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_exp_cancellation_request$fk_cancel_request_decl_co_exp] FOREIGN KEY ([declcoexport_decl_id]) REFERENCES [aes2].[ecs_exp_declcoexport] ([decl_id])
);
