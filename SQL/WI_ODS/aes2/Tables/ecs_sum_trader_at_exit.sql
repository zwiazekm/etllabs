CREATE TABLE [aes2].[ecs_sum_trader_at_exit] (
    ...
    CONSTRAINT [ecs_sum_trader_at_exit$ecs_sum_tr_9134352971] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_sum_trader_at_exit$fk_trader_at_exit_exs] FOREIGN KEY ([exs_id]) REFERENCES [aes2].[ecs_sum_declcoexit] ([decl_id])
);
