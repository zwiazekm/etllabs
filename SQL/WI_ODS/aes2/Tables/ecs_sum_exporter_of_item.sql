CREATE TABLE [aes2].[ecs_sum_exporter_of_item] (
    ...
    CONSTRAINT [ecs_sum_exporter_of_item$ecs_sum_ex_7854348411] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_sum_exporter_of_item$fk_sum_item_sum_goods_item] FOREIGN KEY ([goods_item_id]) REFERENCES [aes2].[ecs_sum_goods_item] ([id])
);
