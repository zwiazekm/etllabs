CREATE TABLE [aes2].[customs_verification_item] (
    ...
    [version]     INT            NULL,
    CONSTRAINT [customs_verification_item$customs_ve_id_9468154041] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AES2],
    CONSTRAINT [customs_verification_item$fk_customs_verification_decl] FOREIGN KEY ([decl_id]) REFERENCES [aes2].[customs_decl] ([id])
);
