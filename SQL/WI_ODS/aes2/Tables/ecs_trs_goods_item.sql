CREATE TABLE [aes2].[ecs_trs_goods_item] (
    ...
    CONSTRAINT [ecs_trs_goods_item$ecs_trs_go_3770493481] PRIMARY KEY CLUSTERED ([ID] ASC) ON [FG_AES2],
    CONSTRAINT [ecs_trs_goods_item$FK_ecs_trs_goods_item] FOREIGN KEY ([DECL_ID]) REFERENCES [aes2].[ecs_trs_declco] ([ID])
);
