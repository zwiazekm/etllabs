CREATE TABLE [ncts2].[historia_zmian_towarow] (
    ...
    CONSTRAINT [historia_zmian_towarow_pk] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_NCTS2],
    CONSTRAINT [historia_zmian_towarow_optr_tranzytowa_id_operacje_tranzytowe_fk] FOREIGN KEY ([operacja_tranzytowa_id]) REFERENCES [ncts2].[operacje_tranzytowe] ([id])
);
