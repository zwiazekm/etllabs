CREATE TABLE [ncts2].[operacje_tranzytowe_szczegoly] (
    ...
    CONSTRAINT [operacje_tranzytowe_szczegoly_pk] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_NCTS2],
    CONSTRAINT [operacje_tranzytowe_szczegoly_optr_id_operacje_tranzytowe_fk] FOREIGN KEY ([operacja_tranzytowa_id]) REFERENCES [ncts2].[operacje_tranzytowe] ([id])
);
