CREATE TABLE [ncts2].[poszukiwania_pobory] (
    ...
    CONSTRAINT [poszukiwania_pobory_pk] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_NCTS2],
    CONSTRAINT [poszukiwania_pobory_komunikat_odpowiedzi_id_id_fk] FOREIGN KEY ([komunikat_odpowiedzi_id]) REFERENCES [ncts2].[komunikaty] ([id]),
    CONSTRAINT [poszukiwania_pobory_komunikat_zapytania_id_id_fk] FOREIGN KEY ([komunikat_zapytania_id]) REFERENCES [ncts2].[komunikaty] ([id]),
    CONSTRAINT [poszukiwania_pobory_operacja_tranzytowa_id_id_fk] FOREIGN KEY ([operacja_tranzytowa_id]) REFERENCES [ncts2].[operacje_tranzytowe] ([id])
);
