CREATE TABLE [ncts].[TRANS_OPER_UNL] (
    ...
    CONSTRAINT [PK_TRANS_OPER_UNL] PRIMARY KEY CLUSTERED ([MRN] ASC, [UNL_VERS_NUMB] ASC) ON [FG_NCTS],
    CONSTRAINT [TOU_UNL_REM_IN_L] FOREIGN KEY ([UNL_REM_LNG]) REFERENCES [ncts].[LANG] ([ID])
);
