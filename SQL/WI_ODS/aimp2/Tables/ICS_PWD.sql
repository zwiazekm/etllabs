CREATE TABLE [aimp2].[ICS_PWD] (
    ...
    CONSTRAINT [ICS_PWD$PK_ICS_PWD] PRIMARY KEY CLUSTERED ([id] ASC) ON [FG_AIMP2],
    CONSTRAINT [ICS_PWD$FK_ICS_PWD_ICS_ZCP] FOREIGN KEY ([id]) REFERENCES [aimp2].[ICS_ZCP] ([ID])
);
