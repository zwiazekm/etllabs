CREATE TABLE [aimp2].[ICS_ZCP_ITEM_PAYMENT] (
    ...
    CONSTRAINT [ICS_ZCP_ITEM_PAYMENT$PK_ICS_ZCP_ITEM_PAYMENT] PRIMARY KEY CLUSTERED ([ID] ASC) ON [FG_AIMP2],
    CONSTRAINT [ICS_ZCP_ITEM_PAYMENT$FK_ICS_ZCP_ITEM_PAYMENT_ICS_ZCP_ITEM] FOREIGN KEY ([ZCP_ITEM_ID]) REFERENCES [aimp2].[ICS_ZCP_ITEM] ([ID]),
    CONSTRAINT [ICS_ZCP_ITEM_PAYMENT$FK_ICS_ZCP_ITEM_PAYMENT_ICS_ZCP_ITEM_PODZ] FOREIGN KEY ([ICS_ZCP_ITEM_PODZ_ID]) REFERENCES [aimp2].[ICS_ZCP_ITEM_PODZ] ([ID])
