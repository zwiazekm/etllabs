CREATE TABLE [aimp2].[ICS_ZCP_PODZ] (
    ...
    CONSTRAINT [ICS_ZCP_PODZ$PK_ICS_ZCP_PODZ] PRIMARY KEY CLUSTERED ([ID] ASC) ON [FG_AIMP2],
    CONSTRAINT [ICS_ZCP_PODZ$FK_ICS_ZCP_PODZ_ICS_ZCP] FOREIGN KEY ([ZCP_ID]) REFERENCES [aimp2].[ICS_ZCP] ([ID])
);
