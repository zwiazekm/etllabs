CREATE TABLE [aimp2].[ICS_DSK_LOKALIZACJA] (
    ...
    CONSTRAINT [ICS_DSK_LOKALIZACJA$PK_ICS_DSK_LOKALIZACJA] PRIMARY KEY CLUSTERED ([ID] ASC) ON [FG_AIMP2],
    CONSTRAINT [ICS_DSK_LOKALIZACJA$FK_ICS_DSK_LOKALIZACJA] FOREIGN KEY ([ICS_DSK_ID]) REFERENCES [aimp2].[ICS_DSK] ([ID])
);
