CREATE TABLE [aimp2].[ICS_ZCP_ITEM_QUOTA] (
    ...
    CONSTRAINT [ICS_ZCP_ITEM_QUOTA$PK_ICS_ZCP_ITEM_QUOTA] PRIMARY KEY CLUSTERED ([ID] ASC) ON [FG_AIMP2],
    CONSTRAINT [ICS_ZCP_ITEM_QUOTA$FK_ICS_ZCP_ITEM_QUOTA_ICS_ZCP_ITEM] FOREIGN KEY ([ZCP_ITEM_ID]) REFERENCES [aimp2].[ICS_ZCP_ITEM] ([ID]),
    CONSTRAINT [ICS_ZCP_ITEM_QUOTA$FK_ICS_ZCP_ITEM_QUOTA_ICS_ZCP_ITEM_QUOTA_DEF] FOREIGN KEY ([ZCP_ITEM_QUOTA_DEF_ID]) REFERENCES [aimp2].[ICS_ZCP_ITEM_QUOTA_DEF] ([ID])
