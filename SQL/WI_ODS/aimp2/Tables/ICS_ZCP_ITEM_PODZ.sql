CREATE TABLE [aimp2].[ICS_ZCP_ITEM_PODZ] (
    ...
    CONSTRAINT [ICS_ZCP_ITEM_PODZ$PK_ICS_ZCP_ITEM_PODZ] PRIMARY KEY CLUSTERED ([ID] ASC) ON [FG_AIMP2],
    CONSTRAINT [ICS_ZCP_ITEM_PODZ$FK_ICS_ZCP_ITEM_PODZ_ICS_ZCP_ITEM] FOREIGN KEY ([ZCP_ITEM_ID]) REFERENCES [aimp2].[ICS_ZCP_ITEM] ([ID])
);
