CREATE TABLE [cel].[v2_sad_UC] (
    ...
    CONSTRAINT [PK_V2_SAD_UC] PRIMARY KEY CLUSTERED ([idDokNr] ASC) WITH (FILLFACTOR = 90) ON [FG_CEL],
    CONSTRAINT [FK_SAD_UC_DOK_SAD] FOREIGN KEY ([idDokNr]) REFERENCES [cel].[v2_dok_info] ([idDokNr])
);
