CREATE TABLE [zef].[slowniki] (
    ...
    [typ2]                  CHAR (1)        NULL,
    [typ3]                  CHAR (1)        NULL,
    CONSTRAINT [PK_SLOWNIKI] PRIMARY KEY CLUSTERED ([id_rodz_slow] ASC, [id_slown] ASC) ON [FG_ZEF],
    CONSTRAINT [CKC_DATA_SLOWNIKI] CHECK ([data] IS NULL OR [data]>='17530101' AND [data]<='99991231')
);
