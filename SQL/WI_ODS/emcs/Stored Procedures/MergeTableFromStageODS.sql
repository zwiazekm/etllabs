...
CREATE PROCEDURE [emcs].[MergeTableFromStageODS] (@TableName VARCHAR(50) = NULL)
AS
BEGIN
	SET NOCOUNT ON;
	...
	END
		...
		IF @TableName = 'DICTIONARIES' BEGIN
			MERGE INTO emcs.DICTIONARIES AS tgt
			USING [WI_StageODS].emcs.DICTIONARIES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.NAME=src.NAME, tgt.DESCRIPTION=src.DESCRIPTION
			WHEN NOT MATCHED
		...
		IF @TableName = 'DICTIONARY_VALUES' BEGIN
			MERGE INTO emcs.DICTIONARY_VALUES AS tgt
			USING [WI_StageODS].emcs.DICTIONARY_VALUES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.CODE=src.CODE, tgt.DESCRIPTION=src.DESCRIPTION, tgt.DESCRIPTION_LANG_CODE=src.DESCRIPTION_LANG_CODE, tgt.VALID_FROM=src.VALID_FROM, tgt.VALID_TO=src.VALID_TO, tgt.DICT_ID=src.DICT_ID, tgt.ACTION_IDENTIFIER=src.ACTION_IDENTIFIER, tgt.INVALIDATE_ACTION_IDENTIFIER=src.INVALIDATE_ACTION_IDENTIFIER
			WHEN NOT MATCHED
		...
		IF @TableName = 'ECS_DECL_VERIFY_RESULTS' BEGIN
			MERGE INTO emcs.ECS_DECL_VERIFY_RESULTS AS tgt
			USING [WI_StageODS].emcs.ECS_DECL_VERIFY_RESULTS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.ECSD_ID=src.ECSD_ID, tgt.ITEM_NUMBER=src.ITEM_NUMBER, tgt.ARC=src.ARC, tgt.MVMT_PRODUCT_NUMBER=src.MVMT_PRODUCT_NUMBER, tgt.MVMT_PRODUCT_ID=src.MVMT_PRODUCT_ID, tgt.ERROR_CODE=src.ERROR_CODE, tgt.ERROR_DESCRIPTION=src.ERROR_DESCRIPTION, tgt.DIAGNOSIS_CODE=src.DIAGNOSIS_CODE
			WHEN NOT MATCHED
		...
		IF @TableName = 'ECS_DECLARATION_MVMTS' BEGIN
			DELETE FROM emcs.ECS_DECLARATION_MVMTS;
			MERGE INTO emcs.ECS_DECLARATION_MVMTS AS tgt
			USING [WI_StageODS].emcs.ECS_DECLARATION_MVMTS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.ECSD_ID=src.ECSD_ID, tgt.ARC=src.ARC, tgt.SEQUENCE_NUMBER=src.SEQUENCE_NUMBER
			WHEN NOT MATCHED
		...
		IF @TableName = 'ECS_DECLARATIONS' BEGIN
			MERGE INTO emcs.ECS_DECLARATIONS AS tgt
			USING [WI_StageODS].emcs.ECS_DECLARATIONS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.MRN=src.MRN, tgt.STATUS=src.STATUS
			WHEN NOT MATCHED
		...
		IF @TableName = 'EMCS_ACO_MESSAGES' BEGIN 
			MERGE INTO emcs.EMCS_ACO_MESSAGES AS tgt
			USING [WI_StageODS].emcs.EMCS_ACO_MESSAGES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.ACO_ID=src.ACO_ID, tgt.PSIN_ID=src.PSIN_ID, tgt.TYPE=src.TYPE, tgt.BODY=src.BODY, tgt.STATUS=src.STATUS, tgt.CREATE_DATE=src.CREATE_DATE, tgt.CREATE_BY=src.CREATE_BY, tgt.CHANGE_DATE=src.CHANGE_DATE, tgt.CHANGE_BY=src.CHANGE_BY, tgt.VERSION=src.VERSION
			WHEN NOT MATCHED
			THEN INSERT (ID, ACO_ID, PSIN_ID, TYPE, BODY, STATUS, CREATE_DATE, CREATE_BY, CHANGE_DATE, CHANGE_BY, VERSION)
			VALUES (src.ID, src.ACO_ID, src.PSIN_ID, src.TYPE, src.BODY, src.STATUS, src.CREATE_DATE, src.CREATE_BY, src.CHANGE_DATE, src.CHANGE_BY, src.VERSION);		
			SET @Merged = 1;
		END
		
		IF @TableName = 'EMCS_ACO_MOVEMENTS' BEGIN
			MERGE INTO emcs.EMCS_ACO_MOVEMENTS AS tgt
			USING [WI_StageODS].emcs.EMCS_ACO_MOVEMENTS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.ACO_ID=src.ACO_ID, tgt.ARC=src.ARC, tgt.SEQUENCE_NUMBER=src.SEQUENCE_NUMBER, tgt.MVMT_ID=src.MVMT_ID
			WHEN NOT MATCHED
		...
		IF @TableName = 'EMCS_ACO_PROCESS_INSTANCES' BEGIN
			MERGE INTO emcs.EMCS_ACO_PROCESS_INSTANCES AS tgt
			USING [WI_StageODS].emcs.EMCS_ACO_PROCESS_INSTANCES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.ACO_ID=src.ACO_ID, tgt.PRIN_ID=src.PRIN_ID
			WHEN NOT MATCHED
		...
		IF @TableName = 'EMCS_ACO_READERS' BEGIN
			MERGE INTO emcs.EMCS_ACO_READERS AS tgt
			USING [WI_StageODS].emcs.EMCS_ACO_READERS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.ACO_ID=src.ACO_ID, tgt.ROLE_ID=src.ROLE_ID, tgt.CREATE_DATE=src.CREATE_DATE, tgt.CREATE_BY=src.CREATE_BY
			WHEN NOT MATCHED
		...
		IF @TableName = 'EMCS_DOWN_MESSAGES' BEGIN
			MERGE INTO emcs.EMCS_DOWN_MESSAGES AS tgt
			USING [WI_StageODS].emcs.EMCS_DOWN_MESSAGES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.VERSION=src.VERSION, tgt.TYPE=src.TYPE, tgt.SENDER=src.SENDER, tgt.RECIPIENT=src.RECIPIENT, tgt.PREPARATION_TIMESTAMP=src.PREPARATION_TIMESTAMP, tgt.IDENTIFIER=src.IDENTIFIER, tgt.CORRELATION_IDENTIFIER=src.CORRELATION_IDENTIFIER, tgt.BODY=src.BODY, tgt.MVMT_ID=src.MVMT_ID
			WHEN NOT MATCHED
		...
		IF @TableName = 'EMCS_EXCISE_RATES' BEGIN
			MERGE INTO emcs.EMCS_EXCISE_RATES AS tgt
			USING [WI_StageODS].emcs.EMCS_EXCISE_RATES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
		...
		IF @TableName = 'EMCS_FOLLOW_UP_MESSAGES' BEGIN
			MERGE INTO emcs.EMCS_FOLLOW_UP_MESSAGES AS tgt
			USING [WI_StageODS].emcs.EMCS_FOLLOW_UP_MESSAGES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.MESSAGE_TYPE=src.MESSAGE_TYPE, tgt.MESSAGE_ID=src.MESSAGE_ID, tgt.OFFICE_REFERENCE_NUMBER=src.OFFICE_REFERENCE_NUMBER, tgt.STATUS=src.STATUS, tgt.ARC=src.ARC, tgt.DESCRIPTION=src.DESCRIPTION, tgt.REPORT_TYPE=src.REPORT_TYPE, tgt.REPORT_NUMBER=src.REPORT_NUMBER, tgt.CONTROL_TYPE=src.CONTROL_TYPE, tgt.HAS_ATTACHMENTS=src.HAS_ATTACHMENTS, tgt.IS_LATEST=src.IS_LATEST, tgt.PARENT_ID=src.PARENT_ID, tgt.SENDER_MSA=src.SENDER_MSA, tgt.RECIPIENT_MSA=src.RECIPIENT_MSA, tgt.CREATE_DATE=src.CREATE_DATE, tgt.CHANGE_DATE=src.CHANGE_DATE, tgt.EVENT_REPORT_REFERENCE=src.EVENT_REPORT_REFERENCE
			WHEN NOT MATCHED
			THEN INSERT (ID, MESSAGE_TYPE, MESSAGE_ID, OFFICE_REFERENCE_NUMBER, STATUS, ARC, DESCRIPTION, REPORT_TYPE, REPORT_NUMBER, CONTROL_TYPE, HAS_ATTACHMENTS, IS_LATEST, PARENT_ID, SENDER_MSA, RECIPIENT_MSA, CREATE_DATE, CHANGE_DATE, EVENT_REPORT_REFERENCE)
			VALUES (src.ID, src.MESSAGE_TYPE, src.MESSAGE_ID, src.OFFICE_REFERENCE_NUMBER, src.STATUS, src.ARC, src.DESCRIPTION, src.REPORT_TYPE, src.REPORT_NUMBER, src.CONTROL_TYPE, src.HAS_ATTACHMENTS, src.IS_LATEST, src.PARENT_ID, src.SENDER_MSA, src.RECIPIENT_MSA, src.CREATE_DATE, src.CHANGE_DATE, src.EVENT_REPORT_REFERENCE);		
			SET @Merged = 1;
		END

		IF @TableName = 'EMCS_TIMER_TYPES' BEGIN
			MERGE INTO emcs.EMCS_TIMER_TYPES AS tgt
			USING [WI_StageODS].emcs.EMCS_TIMER_TYPES AS src
		...
		IF @TableName = 'EMCS_TIMERS' BEGIN
			MERGE INTO emcs.EMCS_TIMERS AS tgt
			USING [WI_StageODS].emcs.EMCS_TIMERS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.TYPE=src.TYPE, tgt.START_DATE=src.START_DATE, tgt.RUNNING=src.RUNNING, tgt.EXPIRED=src.EXPIRED, tgt.LIMIT_DATE=src.LIMIT_DATE, tgt.STOP_DATE=src.STOP_DATE, tgt.MVMT_ID=src.MVMT_ID, tgt.USER_TASK_ID=src.USER_TASK_ID, tgt.ACO_ID=src.ACO_ID
			WHEN NOT MATCHED
		...
		IF @TableName = 'EMCS_USER_TASK_TYPES' BEGIN
			MERGE INTO emcs.EMCS_USER_TASK_TYPES AS tgt
			USING [WI_StageODS].emcs.EMCS_USER_TASK_TYPES AS src
		...
		IF @TableName = 'EMCS_USER_TASKS_SAD_DOCS' BEGIN
			MERGE INTO emcs.EMCS_USER_TASKS_SAD_DOCS AS tgt
			USING [WI_StageODS].emcs.EMCS_USER_TASKS_SAD_DOCS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.SAD_NUMBER=src.SAD_NUMBER, tgt.USER_TASK_ID=src.USER_TASK_ID
			WHEN NOT MATCHED
		...
		IF @TableName = 'MESSAGE_TYPES' BEGIN
			MERGE INTO emcs.MESSAGE_TYPES AS tgt
			USING [WI_StageODS].emcs.MESSAGE_TYPES AS src
		...
		IF @TableName = 'MVMT_DOWNSTREAM_MOVEMENTS' BEGIN
			MERGE INTO emcs.MVMT_DOWNSTREAM_MOVEMENTS AS tgt
			USING [WI_StageODS].emcs.MVMT_DOWNSTREAM_MOVEMENTS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
		...
		IF @TableName = 'MVMT_INTERESTED_OFFICES' BEGIN
			MERGE INTO emcs.MVMT_INTERESTED_OFFICES AS tgt
			USING [WI_StageODS].emcs.MVMT_INTERESTED_OFFICES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.SEQUENCE_NUMBER=src.SEQUENCE_NUMBER, tgt.OFFICE_REFNUM=src.OFFICE_REFNUM, tgt.MVMT_ID=src.MVMT_ID
			WHEN NOT MATCHED
		...
		IF @TableName = 'MVMT_SAD_DOCUMENTS' BEGIN
			MERGE INTO emcs.MVMT_SAD_DOCUMENTS AS tgt
			USING [WI_StageODS].emcs.MVMT_SAD_DOCUMENTS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.SAD_NUMBER=src.SAD_NUMBER, tgt.MVMT_ID=src.MVMT_ID
			WHEN NOT MATCHED
		...
		IF @TableName = 'MVMT_WINE_OPERATION_CODES' BEGIN
			MERGE INTO emcs.MVMT_WINE_OPERATION_CODES AS tgt
			USING [WI_StageODS].emcs.MVMT_WINE_OPERATION_CODES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.WINE_OPERATION_CODE=src.WINE_OPERATION_CODE, tgt.MVMT_PRODUCT_ID=src.MVMT_PRODUCT_ID
			WHEN NOT MATCHED
		...
		IF @TableName = 'PACKAGING_CODES' BEGIN
			MERGE INTO emcs.PACKAGING_CODES AS tgt
			USING [WI_StageODS].emcs.PACKAGING_CODES AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.CODE=src.CODE, tgt.DESCRIPTION=src.DESCRIPTION, tgt.DESCRIPTION_LANG_CODE=src.DESCRIPTION_LANG_CODE, tgt.COUNTABLE=src.COUNTABLE, tgt.VALID_FROM=src.VALID_FROM, tgt.VALID_TO=src.VALID_TO, tgt.ACTION_IDENTIFIER=src.ACTION_IDENTIFIER, tgt.INVALIDATE_ACTION_IDENTIFIER=src.INVALIDATE_ACTION_IDENTIFIER, tgt.SEED_CODE=src.SEED_CODE
			WHEN NOT MATCHED
		...
		IF @TableName = 'REF_SD2_PRZEDSTAWICIELE' BEGIN
			MERGE INTO emcs.REF_SD2_PRZEDSTAWICIELE AS tgt
			USING [WI_StageODS].emcs.REF_SD2_PRZEDSTAWICIELE AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.REF_SD2_PODMIOTY_NRA=src.REF_SD2_PODMIOTY_NRA, tgt.IMIE=src.IMIE, tgt.NAZWISKO=src.NAZWISKO, tgt.PESEL=src.PESEL, tgt.X509_THUMBPRINT=src.X509_THUMBPRINT, tgt.REF_SD2_PODMIOTY_TYP=src.REF_SD2_PODMIOTY_TYP
			WHEN NOT MATCHED
		...
		IF @TableName = 'REF_SD2_UBYTKI_TRANS' BEGIN
			MERGE INTO emcs.REF_SD2_UBYTKI_TRANS AS tgt
			USING [WI_StageODS].emcs.REF_SD2_UBYTKI_TRANS AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.REF_SD2_PODMIOTY_NRA=src.REF_SD2_PODMIOTY_NRA, tgt.REF_SD2_PODMIOTY_TYP=src.REF_SD2_PODMIOTY_TYP, tgt.KOD=src.KOD, tgt.NORMA=src.NORMA, tgt.SPOSOB_WYLICZENIA=src.SPOSOB_WYLICZENIA, tgt.OBOWIAZUJE_OD=src.OBOWIAZUJE_OD, tgt.OBOWIAZUJE_DO=src.OBOWIAZUJE_DO
			WHEN NOT MATCHED
		...
		IF @TableName = 'REF_SD2_UBYTKI_TRANS_KODY_CN' BEGIN
			MERGE INTO emcs.REF_SD2_UBYTKI_TRANS_KODY_CN AS tgt
			USING [WI_StageODS].emcs.REF_SD2_UBYTKI_TRANS_KODY_CN AS src
		...
		IF @TableName = 'REF_SD2_UBYTKI_TRANS_OPAK' BEGIN
			MERGE INTO emcs.REF_SD2_UBYTKI_TRANS_OPAK AS tgt
			USING [WI_StageODS].emcs.REF_SD2_UBYTKI_TRANS_OPAK AS src
		...
		IF @TableName = 'REF_SD2_UBYTKI_TRANS_SRODKI' BEGIN
			MERGE INTO emcs.REF_SD2_UBYTKI_TRANS_SRODKI AS tgt
			USING [WI_StageODS].emcs.REF_SD2_UBYTKI_TRANS_SRODKI AS src
		...
		IF @TableName = 'REF_SD2_WLASCICIELE' BEGIN
			MERGE INTO emcs.REF_SD2_WLASCICIELE AS tgt
			USING [WI_StageODS].emcs.REF_SD2_WLASCICIELE AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.NRA=src.NRA, tgt.TYP=src.TYP, tgt.WLASCICIEL_NRA=src.WLASCICIEL_NRA, tgt.WLASCICIEL_TYP=src.WLASCICIEL_TYP
			WHEN NOT MATCHED
		...
		IF @TableName = 'REF_SD2_WYROBY' BEGIN
			MERGE INTO emcs.REF_SD2_WYROBY AS tgt
			USING [WI_StageODS].emcs.REF_SD2_WYROBY AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.REF_SD2_PODMIOTY_NRA=src.REF_SD2_PODMIOTY_NRA, tgt.KATEGORIA=src.KATEGORIA, tgt.KOD=src.KOD, tgt.ILOSC=src.ILOSC, tgt.JEDNOSTKA=src.JEDNOSTKA, tgt.REF_SD2_PODMIOTY_TYP=src.REF_SD2_PODMIOTY_TYP
			WHEN NOT MATCHED
		...
		IF @TableName = 'REF_SD2_ZABEZPIECZENIA' BEGIN
			MERGE INTO emcs.REF_SD2_ZABEZPIECZENIA AS tgt
			USING [WI_StageODS].emcs.REF_SD2_ZABEZPIECZENIA AS src
			ON (tgt.ID=src.ID)
			WHEN MATCHED
			THEN UPDATE SET
			tgt.REF_SD2_PODMIOTY_NRA=src.REF_SD2_PODMIOTY_NRA, tgt.NR_GRN=src.NR_GRN, tgt.OBOWIAZUJE_OD=src.OBOWIAZUJE_OD, tgt.OBOWIAZUJE_DO=src.OBOWIAZUJE_DO, tgt.REF_SD2_PODMIOTY_TYP=src.REF_SD2_PODMIOTY_TYP
			WHEN NOT MATCHED
