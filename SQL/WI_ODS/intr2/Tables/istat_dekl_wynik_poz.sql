CREATE TABLE [intr2].[istat_dekl_wynik_poz] (
    ...
    CONSTRAINT [istat_dekl_wynik_poz$PK_ISTAT_DEKL_WYNIK_POZ] PRIMARY KEY CLUSTERED ([id_dok] ASC, [pozid] ASC) ON [FG_INTR2],
    CONSTRAINT [istat_dekl_wynik_poz$FK_ISTAT_DE_REF_ISTAT_DEKL_POZ] FOREIGN KEY ([id_dok]) REFERENCES [intr2].[istat_dekl_wynik_dok] ([id_dok])
);
