CREATE TABLE [intr2].[istat_dane_wlasne_podmiotu] (
    ...
    CONSTRAINT [istat_dane_wlasne_podmiotu$PK_istat_dane_wlasne_podmiotu] PRIMARY KEY CLUSTERED ([id_pod] ASC) ON [FG_INTR2],
    CONSTRAINT [istat_dane_wlasne_podmiotu$FK_istat_dane_wlasne_podmiotu_id_pod__intr_dane_pod_id_pod] FOREIGN KEY ([id_pod]) REFERENCES [intr2].[intr_dane_pod] ([id_pod])
);
