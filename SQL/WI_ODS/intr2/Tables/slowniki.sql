CREATE TABLE [intr2].[slowniki] (
    ...
    CONSTRAINT [slowniki$pk_slowniki] PRIMARY KEY CLUSTERED ([id_rodz_slow] ASC, [id_slown] ASC) ON [FG_INTR2],
    CONSTRAINT [slowniki$fk_slowniki_ref_5851_rodzslow] FOREIGN KEY ([id_rodz_slow]) REFERENCES [intr2].[rodzslow] ([id_rodz_slow])
);
