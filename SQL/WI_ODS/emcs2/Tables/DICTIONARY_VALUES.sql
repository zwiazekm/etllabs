CREATE TABLE [emcs2].[DICTIONARY_VALUES] (
    ...
    CONSTRAINT [PK_DICTIONARY_VALUES] PRIMARY KEY CLUSTERED ([ID] ASC) ON [FG_EMCS2],
    CONSTRAINT [FK_DICTVALUES_DICT] FOREIGN KEY ([DICT_ID]) REFERENCES [emcs2].[DICTIONARIES] ([ID])
);
