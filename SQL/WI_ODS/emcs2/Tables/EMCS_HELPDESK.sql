CREATE TABLE [emcs2].[EMCS_HELPDESK] (
    ...
    CONSTRAINT [PK_EMCS_HELPDESK] PRIMARY KEY CLUSTERED ([ID] ASC) ON [FG_EMCS2],
    CONSTRAINT [FK_EMCS_HELPDESK_HD001] FOREIGN KEY ([HD001_MSG_ID]) REFERENCES [emcs2].[EMCS_PROCESS_COMM] ([ID]),
    CONSTRAINT [FK_EMCS_HELPDESK_HD002] FOREIGN KEY ([HD002_MSG_ID]) REFERENCES [emcs2].[EMCS_PROCESS_COMM] ([ID])
);
