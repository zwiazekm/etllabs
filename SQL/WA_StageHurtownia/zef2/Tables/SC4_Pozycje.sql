CREATE TABLE [zef2].[SC4_Pozycje] (
    ...
    [Paragraf4010]                      NUMERIC (32, 16) NULL,
    [Paragraf4020]                      NUMERIC (32, 16) NULL,
    [Paragraf4050]                      NUMERIC (32, 16) NULL,
    [Paragraf4060]                      NUMERIC (32, 16) NULL,
    [LiczbaFunkcjonariuszy]             NUMERIC (32, 16) NULL,
    [LiczbaWyplaconychSwiadczen]        NUMERIC (32, 16) NULL,
    ...
    CONSTRAINT [SC4_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC)
);
