CREATE TABLE [zef2].[RB28UE_Pozycje] (
    ...
    [PlatnNarastPoczRoku]               NUMERIC (32, 16) NULL,
    [ZwrotyNarastPoczRokuPlatnBiez]     NUMERIC (32, 16) NULL,
    ...
    [KodWiersza]                        NVARCHAR (60)    NULL,
    [Uwagi]                             NVARCHAR (150)   NULL,
    [operacja]                          NVARCHAR (1)     NULL,
    CONSTRAINT [RB28UE_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC),
