CREATE TABLE [zef2].[RB28Programy_Pozycje] (
    ...
    [PlanPoZmianachUE]                  NUMERIC (32, 16) NULL,
    [PlanPoZmianachBP]                  NUMERIC (32, 16) NULL,
    [ZaangazowanieUE]                   NUMERIC (32, 16) NULL,
    [ZaangazowanieBP]                   NUMERIC (32, 16) NULL,
    [WykonanieWydatkowUE]               NUMERIC (32, 16) NULL,
    [WykonanieWydatkowBP]               NUMERIC (32, 16) NULL,
    ...
    CONSTRAINT [RB28Programy_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC),
