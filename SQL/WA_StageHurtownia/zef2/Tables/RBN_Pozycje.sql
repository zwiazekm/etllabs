CREATE TABLE [zef2].[RBN_Pozycje] (
    ...
    [KwotaNaleznosciOgolem]                NUMERIC (32, 16) NULL,
    ...
    [InstytNiekomercNaRzeczGospodarstwDom] NUMERIC (32, 16) NULL,
    ...
    CONSTRAINT [RBN_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC)
);
