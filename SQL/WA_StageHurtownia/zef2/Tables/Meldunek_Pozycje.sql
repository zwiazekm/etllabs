CREATE TABLE [zef2].[Meldunek_Pozycje] (
    [Opis]                              NVARCHAR (250)   NULL,
    [NumerWiersza]                      NUMERIC (32, 16) NULL,
    [StanNaTenMiesiac]                  NUMERIC (32, 16) NULL,
    [StanNarastajaco]                   NUMERIC (32, 16) NULL,
    ...
    CONSTRAINT [Meldunek_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC)
);
