CREATE TABLE [zef2].[RB28ProgramyWPR_Dokument] (
    ...
    CONSTRAINT [RB28ProgramyWPR_Dokument_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC),
    CONSTRAINT [CK__RB28Progr__Ident__61915EA7] CHECK ([IdentyfikatorRekordu]<>(0))
);
