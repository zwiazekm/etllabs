CREATE TABLE [zef2].[RB70_Pozycje] (
    [Opis]                                  NVARCHAR (250)   NULL,
    [NumerWiersza]                          NUMERIC (32, 16) NULL,
    [PlanPoZmianach]                        NUMERIC (32, 16) NULL,
    [PrzecietneWykonanieWokresieSprawozdaw] NUMERIC (32, 16) NULL,
    [StanNaKoniecOkresuSprawodaw]           NUMERIC (32, 16) NULL,
    [PlanOsoboweUposazenia]                 NUMERIC (32, 16) NULL,
    [PlanDodatkoweWynagrodzenieRoczne]      NUMERIC (32, 16) NULL,
    [WykonanieOsoboweUposazenia]            NUMERIC (32, 16) NULL,
    [DodatkoweWynagrodzenieRoczne]          NUMERIC (32, 16) NULL,
    ...
    CONSTRAINT [RB70_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatoRekordu] ASC),
