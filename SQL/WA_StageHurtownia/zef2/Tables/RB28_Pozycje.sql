CREATE TABLE [zef2].[RB28_Pozycje] (
    ...
    [WykonanieWydatkow]                 NUMERIC (32, 16) NULL,
    [OgolemZobowiazania]                NUMERIC (32, 16) NULL,
    [ZobowLatUbieglych]                 NUMERIC (32, 16) NULL,
    [ZobowBiezacegoRoku]                NUMERIC (32, 16) NULL,
    [WydatkiNiewygasle]                 NUMERIC (32, 16) NULL,
    ...
    CONSTRAINT [RB28_Pozycje_pk] PRIMARY KEY CLUSTERED ([IdentyfikatorRekordu] ASC),
